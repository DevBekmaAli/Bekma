...
local TheBekme = io.open("TheBekme", 'w')
TheBekme:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
sudo lua5.3 Bekme.lua
done
]])
TheBekme:close()
...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S TheBekme -X kill
screen -S TheBekme ./TheBekme
done
]])
Run:close()
...
os.execute('chmod +x TheBekme;chmod +x Run;./Run')
end
...
TheBekme = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..TheBekme)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=TheBekme,token=Token}
function var(value)  
...
ControllerAll = false
local ListSudos ={Sudo_Id,1122282868}  
...
Status = 0
DevelopersQ = Redis:sismember(TheBekme.."Bekme:DevelopersQ:Groups",UserId) 
if UserId == 1122282868 then
Status = true
elseif UserId == 1122282868 then
Status = true
elseif UserId == Sudo_Id then  
Status = true
elseif UserId == TheBekme then
Status = true
...
Status = 0
Developers = Redis:sismember(TheBekme.."Bekme:Developers:Groups",UserId) 
DevelopersQ = Redis:sismember(TheBekme.."Bekme:DevelopersQ:Groups",UserId) 
TheBasicsQ = Redis:sismember(TheBekme.."Bekme:TheBasicsQ:Group"..ChatId,UserId) 
TheBasics = Redis:sismember(TheBekme.."Bekme:TheBasics:Group"..ChatId,UserId) 
Originators = Redis:sismember(TheBekme.."Bekme:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(TheBekme.."Bekme:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(TheBekme.."Bekme:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(TheBekme.."Bekme:Distinguished:Group"..ChatId,UserId)
...
Status = 'المطور'
elseif DevelopersQ then
Status = Redis:get(TheBekme.."Bekme:Developer:Bot:Reply"..ChatId) or 'المطور الثانوي'
elseif TheBasicsQ then
Status = "المالك"
elseif TheBasics then
Status = Redis:get(TheBekme.."Bekme:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(TheBekme.."Bekme:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(TheBekme.."Bekme:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(TheBekme.."Bekme:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك الكروب'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(TheBekme.."Bekme:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(TheBekme.."Bekme:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(TheBekme.."Bekme:lockpin"..ChatId) then    
lock_pin = "✔️"
else 
lock_pin = "❌"    
end
if Redis:get(TheBekme.."Bekme:Lock:tagservr"..ChatId) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "❌"
end
if Redis:get(TheBekme.."Bekme:Lock:text"..ChatId) then    
lock_text = "✔️"
else 
lock_text = "❌ "    
end
if Redis:get(TheBekme.."Bekme:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔️"
else 
lock_add = "❌ "    
end    
if Redis:get(TheBekme.."Bekme:Lock:Join"..ChatId) == "kick" then
lock_join = "✔️"
else 
lock_join = "❌ "    
end    
if Redis:get(TheBekme.."Bekme:Lock:edit"..ChatId) then    
lock_edit = "✔️"
else 
lock_edit = "❌ "    
end
if Redis:get(TheBekme.."Bekme:Chek:Welcome"..ChatId) then
welcome = "✔️"
else 
welcome = "❌ "    
end
if Redis:hget(TheBekme.."Bekme:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(TheBekme.."Bekme:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(TheBekme.."Bekme:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(TheBekme.."Bekme:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔️"
else     
flood = "❌ "     
end
if Redis:get(TheBekme.."Bekme:Lock:Photo"..ChatId) == "del" then
lock_photo = "✔️" 
elseif Redis:get(TheBekme.."Bekme:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(TheBekme.."Bekme:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(TheBekme.."Bekme:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(TheBekme.."Bekme:Lock:Contact"..ChatId) == "del" then
lock_phon = "✔️" 
elseif Redis:get(TheBekme.."Bekme:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(TheBekme.."Bekme:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(TheBekme.."Bekme:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(TheBekme.."Bekme:Lock:Link"..ChatId) == "del" then
lock_links = "✔️"
elseif Redis:get(TheBekme.."Bekme:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(TheBekme.."Bekme:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(TheBekme.."Bekme:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(TheBekme.."Bekme:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔️"
elseif Redis:get(TheBekme.."Bekme:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(TheBekme.."Bekme:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(TheBekme.."Bekme:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(TheBekme.."Bekme:Lock:User:Name"..ChatId) == "del" then
lock_user = "✔️"
elseif Redis:get(TheBekme.."Bekme:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(TheBekme.."Bekme:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(TheBekme.."Bekme:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(TheBekme.."Bekme:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔️"
elseif Redis:get(TheBekme.."Bekme:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(TheBekme.."Bekme:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(TheBekme.."Bekme:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(TheBekme.."Bekme:Lock:vico"..ChatId) == "del" then
lock_muse = "✔️"
elseif Redis:get(TheBekme.."Bekme:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(TheBekme.."Bekme:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(TheBekme.."Bekme:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(TheBekme.."Bekme:Lock:Video"..ChatId) == "del" then
lock_ved = "✔️"
elseif Redis:get(TheBekme.."Bekme:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(TheBekme.."Bekme:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(TheBekme.."Bekme:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(TheBekme.."Bekme:Lock:Animation"..ChatId) == "del" then
lock_gif = "✔️"
elseif Redis:get(TheBekme.."Bekme:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(TheBekme.."Bekme:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(TheBekme.."Bekme:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(TheBekme.."Bekme:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔️"
elseif Redis:get(TheBekme.."Bekme:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(TheBekme.."Bekme:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(TheBekme.."Bekme:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(TheBekme.."Bekme:Lock:geam"..ChatId) == "del" then
lock_geam = "✔️"
elseif Redis:get(TheBekme.."Bekme:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(TheBekme.."Bekme:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(TheBekme.."Bekme:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(TheBekme.."Bekme:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔️"
elseif Redis:get(TheBekme.."Bekme:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(TheBekme.."Bekme:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(TheBekme.."Bekme:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(TheBekme.."Bekme:Lock:forward"..ChatId) == "del" then
lock_fwd = "✔️"
elseif Redis:get(TheBekme.."Bekme:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(TheBekme.."Bekme:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(TheBekme.."Bekme:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(TheBekme.."Bekme:Lock:Document"..ChatId) == "del" then
lock_file = "✔️"
elseif Redis:get(TheBekme.."Bekme:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(TheBekme.."Bekme:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(TheBekme.."Bekme:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(TheBekme.."Bekme:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔️"
elseif Redis:get(TheBekme.."Bekme:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(TheBekme.."Bekme:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(TheBekme.."Bekme:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(TheBekme.."Bekme:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔️"
elseif Redis:get(TheBekme.."Bekme:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(TheBekme.."Bekme:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(TheBekme.."Bekme:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔️"
elseif Redis:get(TheBekme.."Bekme:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(TheBekme.."Bekme:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(TheBekme.."Bekme:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(TheBekme.."Bekme:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔️"
elseif Redis:get(TheBekme.."Bekme:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(TheBekme.."Bekme:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(TheBekme.."Bekme:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
BanAll = Redis:sismember(TheBekme.."Bekme:BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(TheBekme.."Bekme:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(TheBekme.."Bekme:SilentGroup:Group"..ChatId,UserId)
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,TheBekme).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(TheBekme..'Bekme:Channel:Join')
if Channel then
...
local msg_id = msg.id
var(msg.content)
if data.sender.luatele == "messageSenderChat" and Redis:get(TheBekme.."Lock:channell"..msg_chat_id) then
print(Redis:get(TheBekme.."chadmin"..msg_chat_id))
print(data.sender.chat_id)
if data.sender.chat_id ~= Redis:get(TheBekme.."chadmin"..msg_chat_id) then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
Redis:incr(TheBekme..'Bekme:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
if tonumber(msg.sender.user_id) == tonumber(TheBekme) then
...
if tonumber(msg.sender.user_id) == 1122282868 then
msg.Name_Controller = 'مطور السورس  '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1122282868 then
msg.Name_Controller = 'مبرمج السورس '
msg.The_Controller = 1
elseif The_ControllerAll(msg.sender.user_id) == true then  
msg.The_Controller = 1
msg.Name_Controller = 'المطور الاساسي '
elseif Redis:sismember(TheBekme.."Bekme:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(TheBekme.."Bekme:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(TheBekme.."Bekme:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(TheBekme.."Bekme:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = "المالك"
elseif Redis:sismember(TheBekme.."Bekme:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(TheBekme.."Bekme:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(TheBekme.."Bekme:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(TheBekme.."Bekme:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(TheBekme.."Bekme:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(TheBekme.."Bekme:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(TheBekme.."Bekme:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(TheBekme.."Bekme:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(TheBekme.."Bekme:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(TheBekme.."Bekme:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(TheBekme) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(TheBekme.."Bekme:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(TheBekme.."Bekme:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheBekme.."Bekme:Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(TheBekme.."Bekme:Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(TheBekme.."Bekme:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(TheBekme) then
return false
end
local floods = Redis:hget(TheBekme.."Bekme:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(TheBekme.."Bekme:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(TheBekme.."Bekme:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(TheBekme.."Bekme:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(TheBekme.."Bekme:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(TheBekme.."Bekme:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(TheBekme.."Bekme:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(TheBekme.."Bekme:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(TheBekme.."Bekme:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
if text and Redis:get(TheBekme..'lock:Fshar'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(TheBekme..'lock:Fars'..msg.chat_id) and not msg.Distinguished then 
...
sens = 400  
if Redis:get(TheBekme.."Bekme:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheBekme.."Bekme:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheBekme.."Bekme:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheBekme.."Bekme:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(TheBekme.."Bekme:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Originators then -- التوجيه
local Fwd_Group = Redis:get(TheBekme.."Bekme:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(TheBekme.."Bekme:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(TheBekme.."Bekme:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(TheBekme.."Bekme:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(TheBekme.."Bekme:lockpin"..msg_chat_id)
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheBekme.."Bekme:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
...
Redis:incr(TheBekme.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(TheBekme.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(TheBekme.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(TheBekme) then
local N = (Redis:get(TheBekme.."Name:Bot") or "بيكما")
photo = LuaTele.getUserProfilePhotos(TheBekme)
...
Redis:set(TheBekme.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(TheBekme.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
Redis:set(TheBekme..':toob:Name:'..msg.sender.user_id,NameLUser)
end
end
if msg.content.luatele == "messageContact" and not msg.Distinguished then  -- الجهات
local Contact_Group = Redis:get(TheBekme.."Bekme:Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(TheBekme.."Bekme:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(TheBekme.."Bekme:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(TheBekme.."Bekme:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(TheBekme.."Bekme:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(TheBekme.."Bekme:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(TheBekme.."Bekme:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(TheBekme.."Bekme:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(TheBekme.."Bekme:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(TheBekme.."Bekme:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(TheBekme.."Bekme:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(TheBekme.."Bekme:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(TheBekme.."Bekme:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(TheBekme.."Bekme:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(TheBekme.."Bekme:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(TheBekme.."Bekme:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(TheBekme..'Bekme:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(TheBekme.."Bekme:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(TheBekme.."Bekme:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(TheBekme.."Bekme:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(TheBekme.."Bekme:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(TheBekme.."Bekme:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(TheBekme.."Bekme:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(TheBekme.."Bekme:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(TheBekme.."Bekme:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(TheBekme..'Bekme:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(TheBekme..'Bekme:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(TheBekme.."Bekme:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(TheBekme.."Bekme:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(TheBekme.."Bekme:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(TheBekme..'Bekme:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(TheBekme..'Bekme:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(TheBekme.."Bekme:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(TheBekme.."Bekme:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(TheBekme.."Bekme:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(TheBekme.."Bekme:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(TheBekme.."Bekme:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(TheBekme.."Bekme:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(TheBekme.."Bekme:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(TheBekme.."Bekme:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(TheBekme..'Bekme:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(TheBekme.."Bekme:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(TheBekme.."Bekme:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(TheBekme.."Bekme:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(TheBekme.."Bekme:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(TheBekme.."Bekme:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(TheBekme.."Bekme:Command:List:Group"..msg_chat_id,text)
...
Redis:del(TheBekme.."Bekme:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(TheBekme.."Bekme:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(TheBekme.."Bekme:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(TheBekme.."Bekme:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(TheBekme.."Bekme:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(TheBekme.."Bekme:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(TheBekme.."Bekme:Command:Reids:Group:New"..msg_chat_id)
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(TheBekme.."Bekme:Command:List:Group"..msg_chat_id,text)
Redis:del(TheBekme.."Bekme:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(TheBekme.."Bekme:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(TheBekme.."Bekme:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(TheBekme.."Bekme:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(TheBekme.."Bekme:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"📥︙تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(TheBekme.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheBekme.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(TheBekme.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(TheBekme.."Bekme:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حفظ ترحيب المجموعه","md",true)     
end
if Redis:get(TheBekme.."Bekme:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheBekme.."Bekme:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(TheBekme.."Bekme:Group:Rules" .. msg_chat_id,text) 
Redis:del(TheBekme.."Bekme:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(TheBekme.."Bekme:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheBekme.."Bekme:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
local test = Redis:get(TheBekme.."Bekme:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(TheBekme.."Bekme:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TheBekme.."Bekme:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheBekme.."Bekme:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheBekme.."Bekme:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheBekme.."Bekme:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(TheBekme.."Bekme:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheBekme.."Bekme:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(TheBekme.."Bekme:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(TheBekme.."Bekme:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(TheBekme.."Bekme:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
...
print(idPhoto)
Redis:set(TheBekme.."Bekme:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حفظ رد للمدير بنجاح \n‹ : ارسل ( "..test.." ) لرئية الرد","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(TheBekme.."Bekme:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TheBekme.."Bekme:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(TheBekme.."Bekme:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(TheBekme.."Bekme:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TheBekme.."Bekme:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TheBekme.."Bekme:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TheBekme.."Bekme:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(TheBekme.."Bekme:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(TheBekme.."Bekme:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(TheBekme.."Bekme:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(TheBekme.."Bekme:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TheBekme.."Bekme:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(TheBekme.."Bekme:List:Manager"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
{
{text = '‹ 𝘵𝘦𝘢𝘮 𝘣𝘦𝘬𝘮𝘢 › ', url='https://t.me/UWUWC'},
},
}
}
...
if text and text:match("^(.*)$") then
if Redis:get(TheBekme.."Bekme:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(TheBekme.."Bekme:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TheBekme.."Bekme:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TheBekme.."Bekme:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TheBekme.."Bekme:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(TheBekme.."Bekme:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TheBekme.."Bekme:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TheBekme.."Bekme:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حذف الرد من ردود المدير ","md",true)  
return false
end
end
if text and Redis:get(TheBekme.."Bekme:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(TheBekme.."Bekme:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(TheBekme.."Bekme:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(TheBekme.."Bekme:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(TheBekme.."Bekme:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(TheBekme.."Bekme:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(TheBekme.."Bekme:Add:Rd:Sudo:Video"..text)
local document = Redis:get(TheBekme.."Bekme:Add:Rd:Sudo:File"..text)
local audio = Redis:get(TheBekme.."Bekme:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(TheBekme.."Bekme:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TheBekme..'Bekme:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(TheBekme..'Bekme:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(TheBekme.."Bekme:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(TheBekme.."Bekme:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(TheBekme.."Bekme:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TheBekme..'Bekme:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(TheBekme.."Bekme:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(TheBekme.."Bekme:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TheBekme.."Bekme:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheBekme.."Bekme:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheBekme.."Bekme:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(TheBekme.."Bekme:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheBekme.."Bekme:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(TheBekme.."Bekme:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheBekme.."Bekme:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(TheBekme.."Bekme:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(TheBekme.."Bekme:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(TheBekme.."Bekme:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(TheBekme.."Bekme:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TheBekme.."Bekme:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(TheBekme.."Bekme:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(TheBekme.."Bekme:List:Rd:Sudo", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(TheBekme.."Bekme:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(TheBekme..'Bekme:'..v..text)
end
Redis:del(TheBekme.."Bekme:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TheBekme.."Bekme:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حذف الرد من ردود المطور","md",true)  
end
end
if Redis:get(TheBekme.."Bekme:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(TheBekme.."Bekme:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(TheBekme.."Bekme:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(TheBekme.."Bekme:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(TheBekme.."Bekme:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(TheBekme.."Bekme:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(TheBekme.."Bekme:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(TheBekme.."Bekme:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(TheBekme.."Bekme:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(TheBekme.."Bekme:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(TheBekme.."Bekme:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(TheBekme.."Bekme:PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheBekme.."Bekme:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(TheBekme.."Bekme:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(TheBekme..'Bekme:Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheBekme.."Bekme:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(TheBekme.."Bekme:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(TheBekme.."Bekme:ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheBekme.."Bekme:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(TheBekme.."Bekme:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheBekme.."Bekme:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(TheBekme.."Bekme:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(TheBekme..'Bekme:GetTexting:DevTheBekme'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر' then 
Redis:del(TheBekme..'Bekme:GetTexting:DevTheBekme'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم الغاء حفظ كليشة المطور')
end
Redis:set(TheBekme..'Bekme:Texting:DevTheBekme',text)
Redis:del(TheBekme..'Bekme:GetTexting:DevTheBekme'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم حفظ كليشة المطور')
end
if Redis:get(TheBekme.."Bekme:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء امر تعين الايدي","md",true)  
Redis:del(TheBekme.."Bekme:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(TheBekme.."Bekme:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TheBekme.."Bekme:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if Redis:get(TheBekme.."Bekme:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(TheBekme.."Bekme:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(TheBekme.."Bekme:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(TheBekme.."Bekme:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "‹ : تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(TheBekme.."Bekme:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(TheBekme.."Bekme:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(TheBekme.."Bekme:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(TheBekme.."Bekme:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "‹ : تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(TheBekme.."Bekme:Game:Smile"..msg.chat_id) then
if text == Redis:get(TheBekme.."Bekme:Game:Smile"..msg.chat_id) then
Redis:incrby(TheBekme.."Bekme:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheBekme.."Bekme:Game:Smile"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : اللعب مره اخره وارسل - سمايل او سمايلات","md",true)
end
end 
if Redis:get(TheBekme.."Game:Countrygof"..msg.chat_id) then
if text == Redis:get(TheBekme.."Game:Countrygof"..msg.chat_id) then
Redis:incrby(TheBekme.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheBekme.."Game:Countrygof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : العب مره اخره وارسل - اعلام","md",true)  
end
end
if Redis:get(TheBekme.."mshaher"..msg.chat_id) then
if text == Redis:get(TheBekme.."mshaher"..msg.chat_id) then
Redis:del(TheBekme.."mshaher"..msg.chat_id)
Redis:incrby(TheBekme.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : العب مره اخره وارسل - بوب او مشاهير","md",true)  
end
end
if Redis:get(TheBekme.."Game:enkliz"..msg.chat_id) then
if text == Redis:get(TheBekme.."Game:enkliz"..msg.chat_id) then
Redis:incrby(TheBekme.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheBekme.."Game:enkliz"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : العب مره اخره وارسل - انجليزي","md",true)  
end
end
if Redis:get(TheBekme.."Bekme:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(TheBekme.."Bekme:Game:Monotonous"..msg.chat_id) then
Redis:del(TheBekme.."Bekme:Game:Monotonous"..msg.chat_id)
Redis:incrby(TheBekme.."Bekme:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : اللعب مره اخره وارسل - الاسرع او ترتيب","md",true)  
end
end 
if Redis:get(TheBekme.."Bekme:Game:Riddles"..msg.chat_id) then
if text == Redis:get(TheBekme.."Bekme:Game:Riddles"..msg.chat_id) then
Redis:incrby(TheBekme.."Bekme:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheBekme.."Bekme:Game:Riddles"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : اللعب مره اخره وارسل - حزوره","md",true)  
end
end
if Redis:get(TheBekme.."Bekme:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(TheBekme.."Bekme:Game:Meaningof"..msg.chat_id) then
Redis:incrby(TheBekme.."Bekme:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheBekme.."Bekme:Game:Meaningof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : اللعب مره اخره وارسل - معاني","md",true)   
end
end
if Redis:get(TheBekme.."Bekme:Game:Reflection"..msg.chat_id) then
if text == Redis:get(TheBekme.."Bekme:Game:Reflection"..msg.chat_id) then
Redis:incrby(TheBekme.."Bekme:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheBekme.."Bekme:Game:Reflection"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : اللعب مره اخره وارسل - العكس","md",true)  
end
end
if Redis:get(TheBekme.."Bekme:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(TheBekme.."Bekme:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(TheBekme.."Bekme:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheBekme.."Bekme:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(TheBekme.."Bekme:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(TheBekme.."Bekme:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(TheBekme.."Bekme:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(TheBekme.."Bekme:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheBekme.."Bekme:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(TheBekme.."Bekme:Game:Difference"..msg.chat_id) then
if text == Redis:get(TheBekme.."Bekme:Game:Difference"..msg.chat_id) then 
Redis:del(TheBekme.."Bekme:Game:Difference"..msg.chat_id)
Redis:incrby(TheBekme.."Bekme:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(TheBekme.."Bekme:Game:Example"..msg.chat_id) then
if text == Redis:get(TheBekme.."Bekme:Game:Example"..msg.chat_id) then 
Redis:del(TheBekme.."Bekme:Game:Example"..msg.chat_id)
Redis:incrby(TheBekme.."Bekme:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(TheBekme..'Bekme:Channel:Join:Name')..'', url = 't.me/'..Redis:get(TheBekme..'Bekme:Channel:Join')}, },}}
...
if tonumber(TheBekme) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(TheBekme..'Bekme:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(TheBekme.."Bekme:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(TheBekme.."Bekme:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(TheBekme.."Bekme:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(TheBekme.."Bekme:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(TheBekme.."Bekme:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(TheBekme.."Bekme:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(TheBekme) then 
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(TheBekme.."Bekme:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(TheBekme.."Bekme:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(TheBekme.."Bekme:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(TheBekme.."Bekme:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(TheBekme.."Bekme:TheBasics:Group"..idg,idASAS)
end;end
end
...
if (Redis:get(TheBekme..'Bekme:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر' then 
Redis:del(TheBekme..'Bekme:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(UserId_Info.id,TheBekme).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(TheBekme..'Bekme:Channel:Join',ChannelUser) 
Redis:set(TheBekme..'Bekme:Channel:Join:Name',UserId_Info.title) 
...
Redis:set(TheBekme..'Bekme:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TheBekme..'Bekme:Channel:Join')
...
--os.execute('rm -rf Bekme.lua')
--download('https://github.com/Mohmmedrg/NIGHTMARE/blob/main/Bekme.lua','Bekme.lua')
...
local Groups = Redis:smembers(TheBekme..'Bekme:ChekBotAdd')  
local UsersBot = Redis:smembers(TheBekme..'Bekme:Num:User:Pv')  
local Get_Json = '{"BotId": '..TheBekme..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(TheBekme.."Bekme:TheBasics:Group"..v)
local Constructor = Redis:smembers(TheBekme.."Bekme:Originators:Group"..v)
local Manager = Redis:smembers(TheBekme.."Bekme:Managers:Group"..v)
local Admin = Redis:smembers(TheBekme.."Bekme:Addictive:Group"..v)
local Vips = Redis:smembers(TheBekme.."Bekme:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
if (Redis:get(TheBekme.."Bekme:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(TheBekme.."Bekme:AddSudosNew"..msg_chat_id)
...
Redis:set(TheBekme.."Bekme:AddSudosNew"..msg_chat_id,true)
...
listrep = Redis:smembers(TheBekme.."Bekme:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'*','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(TheBekme.."Bekme:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(TheBekme.."Bekme:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(TheBekme.."Bekme:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(TheBekme.."Bekme:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(TheBekme.."Bekme:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(TheBekme.."Bekme:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(TheBekme.."Bekme:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(TheBekme.."Bekme:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(TheBekme.."Bekme:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(TheBekme.."Bekme:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(TheBekme.."Bekme:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(TheBekme.."Bekme:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(TheBekme.."Bekme:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(TheBekme.."Bekme:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
Redis:set(TheBekme..'Bekme:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
local photo = LuaTele.getUserProfilePhotos(TheBekme)
local UserInfo = LuaTele.getUser(TheBekme)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
break
end 
NamesBot = (Redis:get(TheBekme.."Bekme:Name:Bot") or "بيكما")
Groups = (Redis:scard(TheBekme..'Bekme:ChekBotAdd') or 0)
Users = (Redis:scard(TheBekme..'Bekme:Num:User:Pv') or 0)
...
{
{text = Jabwa, url = 'https://t.me/UU7UD'}, 
},
{
{text = Grosupsw, url = 'https://t.me/UWUWC'}, 
},
{
{text = Usperos, url = 'https://t.me/UWUWC'}, 
},
}
...
local NumAdd = Redis:get(TheBekme.."Bekme:Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(TheBekme.."Bekme:Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
...
if Redis:sismember(TheBekme.."Bekme:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(TheBekme..'Bekme:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'⌔ : عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(TheBekme..'Bekme:Num:Add:Bot'),"md",true)  
end
...
if UserInfo.first_name ~= "" then
Redis:sadd(TheBekme.."Bekme:TheBasicsQ:Group"..msg_chat_id,v.member_id.user_id) 
end
end
end
Redis:sadd(TheBekme.."Bekme:TheBasicsQ:Group"..msg_chat_id,msg.sender.user_id) 
Redis:sadd(TheBekme.."Bekme:ChekBotAdd",msg_chat_id)
Redis:set(TheBekme.."Bekme:Status:Id"..msg_chat_id,true) ;Redis:set(TheBekme.."Bekme:Status:Reply"..msg_chat_id,true) ;Redis:set(TheBekme.."Bekme:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(TheBekme.."Bekme:Status:BanId"..msg_chat_id,true) ;Redis:set(TheBekme.."Bekme:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(TheBekme.."Bekme:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(TheBekme.."Bekme:ChekBotAdd",msg_chat_id) then
...
Redis:srem(TheBekme.."Bekme:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(TheBekme.."Bekme:ChekBotAdd",msg_chat_id) then
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n*‹ : اهلا بك مجددا عزيزي \n‹ : اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس بيكما فقط اضغط على الامر الذي تريد تنفيذه *','md', true, false, false, false, reply_markup)
end
...
Redis:set(TheBekme.."lockalllll"..msg_chat_id,"off")
...
Redis:set(TheBekme.."lockalllll"..msg_chat_id,"on")
...
if Redis:get(TheBekme.."lockalllll"..msg_chat_id) == "on" then
if not msg.Addictive then
...
Redis:del(TheBekme..'Abs:gif:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل المتحركه'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheBekme..'Abs:gif:Abs'..msg.chat_id,true)  
end
if text and (text == "متحركه" or text == "↫ متحركه ✯") and not Redis:get(TheBekme..'Abs:gif:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل الميمز'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheBekme..'Abs:memz:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الميمز'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheBekme..'Abs:memz:Abs'..msg.chat_id,true)  
end
if text and (text == "ميمز" or text == "↫ ميمز ✯") and not Redis:get(TheBekme..'Abs:memz:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل الريمكس'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheBekme..'Abs:Remix:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الريمكس'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheBekme..'Abs:Remix:Abs'..msg.chat_id,true)  
end
...
local F333F = ' \n‹ : تم تفعيل الصوره'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheBekme..'Abs:Photo:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الصوره'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheBekme..'Abs:Photo:Abs'..msg.chat_id,true)  
end
if text and (text == "صوره" or text == "↫ صوره ✯") and not Redis:get(TheBekme..'Abs:Photo:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل الانمي'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheBekme..'Abs:Anime:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الانمي'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheBekme..'Abs:Anime:Abs'..msg.chat_id,true)  
end
if text and (text == "انمي" or text == "↫ انمي ✯") and not Redis:get(TheBekme..'Abs:Anime:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل الافلام'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheBekme..'Abs:Movies:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الافلام'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheBekme..'Abs:Movies:Abs'..msg.chat_id,true)  
end
if text and (text == "فلم" or text == "↫ فلم ✯") and not Redis:get(TheBekme..'Abs:Movies:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل المسلسلات'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheBekme..'Abs:Series:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل المسلسلات'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheBekme..'Abs:Series:Abs'..msg.chat_id,true)  
end
if text and (text == "مسلسل" or text == "↫ مسلسل ✯") and not Redis:get(TheBekme..'Abs:Series:Abs'..msg.chat_id) then
...
if text == 'بايو' and not Redis:get(TheBekme..'idnotmembio'..msg.chat_id)  then
...
if Redis:get(TheBekme..'idnotmembio'..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '‹ : تم تعطيل امر البايو مسبقا\n ✓',"md")
else
Redis:set(TheBekme.."idnotmembio"..msg.chat_id,"true")
...
if not Redis:get(TheBekme..'idnotmembio'..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '‹ : تم تفعيل امر البايو مسبقا\n ✓',"md")
else
Redis:del(TheBekme.."idnotmembio"..msg.chat_id)
...
if Redis:get(TheBekme..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id) == "sendlove" then
...
Redis:del(TheBekme..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id)
end
if Redis:get(TheBekme..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '‹ : اليك النتائج الخـاصة :\n\n‹ : نسبة الغباء  : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(TheBekme..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id)
end
if Redis:get(TheBekme..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '‹ : اليك النتائج الخـاصة :\n\n‹ : نسبة الذكاء  : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(TheBekme..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id)
end
if text and Redis:get(TheBekme..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id) == "sendkrhe" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '⌯ اليك النتائج الخـاصة :\n\n⌯ نسبه الكرة : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(TheBekme..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id)
end
if text and text ~="نسبه الرجوله" and Redis:get(TheBekme..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id) == "sendrjoe" then
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","🥰 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '‹ : اليك النتائج الخـاصة :\n\n‹ : نسبة الرجوله لـ : *'..text..'* '..sendnuj..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(TheBekme..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id)
end
if text and text ~="نسبه الانوثه" and Redis:get(TheBekme..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id) == "sendanoe" then
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","?? 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '‹ : اليك النتائج الخـاصة :\n\n‹ : نسبه الانوثة لـ : *'..text..'* '..sendnuj..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(TheBekme..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id)
end

if text == "نسبه الحب" or text == "نسبه حب" and msg.reply_to_message_id ~= 0 then
if not Redis:get(TheBekme.."AlNsb"..msg.chat_id) then    
Redis:set(TheBekme..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id,"sendlove")
...
if not Redis:get(TheBekme.."AlNsb"..msg.chat_id) then    
Redis:set(TheBekme..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id,"sendlove")
...
if not Redis:get(TheBekme.."AlNsb"..msg.chat_id) then    
Redis:set(TheBekme..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id,"sendlove")
hggg = '‹ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(TheBekme.."AlNsb"..msg.chat_id) then    
Redis:set(TheBekme..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id,"sendkrhe")
hggg = '‹ : الان ارسل اسمك واسم الشخص الثاني :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(TheBekme.."AlNsb"..msg.chat_id) then    
Redis:set(TheBekme..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id,"sendrjoe")
hggg = '‹ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(TheBekme.."AlNsb"..msg.chat_id) then    
Redis:set(TheBekme..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id,"sendanoe")
hggg = '‹ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if Redis:get(TheBekme..'AlNsb'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم تعطيل النسب مسبقا\n ✓',"md")
else
Redis:set(TheBekme.."AlNsb"..msg.chat_id,"true")
...
Redis:del(TheBekme.."AlNsb"..msg.chat_id)
...
if Redis:get(TheBekme..'myphoto'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم تعطيل صورتي مسبقا\n ✓',"md")
else
Redis:set(TheBekme.."myphoto"..msg.chat_id,"off")
...
if not Redis:get(TheBekme..'myphoto'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم تفعيل صورتي مسبقا\n ✓',"md")
else
Redis:del(TheBekme.."myphoto"..msg.chat_id)
...
Redis:del(TheBekme.."mybuti"..msg_chat_id)
...
Redis:set(TheBekme.."mybuti"..msg_chat_id,"off")
...
Redis:del(TheBekme.."sayy"..msg_chat_id)
...
Redis:set(TheBekme.."sayy"..msg_chat_id,"off")
LuaTele.sendText(msg_chat_id,msg_id,'\n*‹ : تم امر امر كول * ',"md",true)  
end
if text == "جمالي" or text == 'نسبه جمالي' then
if Redis:get(TheBekme.."mybuti"..msg_chat_id) == "off" then
...
if Redis:get(TheBekme.."sayy"..msg_chat_id) == "off" then
...
if text == "صورتي" then
if Redis:get(TheBekme.."myphoto"..msg_chat_id) == "off" then
...
Redis:set(TheBekme.."Bekme:Set:Id:Group"..msg.chat_id,Text_Rand)
...
if not Redis:get(TheBekme.."Bekme:Status:Id"..msg_chat_id) then
return false
end
local InfoUser = LuaTele.getUserFullInfo(msg.sender.user_id)
if InfoUser.bio then
...
local TotalMsg = Redis:get(TheBekme..'Bekme:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(TheBekme..'Bekme:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(TheBekme.."Bekme:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(TheBekme.."Bekme:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
local Texting = {
'صورتك فدشي خيالي',
"شتحس مخلي هلصورا ؟ ",
"محتحت اقسم",
...
Get_Is_Id = Redis:get(TheBekme.."Bekme:Set:Id:Group"..msg_chat_id)
if Redis:get(TheBekme.."Bekme:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
local TotalMsg = Redis:get(TheBekme..'Bekme:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(TheBekme..'Bekme:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*‹ : ايديه : '..UserId..
...
local TotalMsg = Redis:get(TheBekme..'Bekme:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(TheBekme..'Bekme:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*‹ : ايديه : '..UserId..
'\n‹ : معرفه : @'..UserName..
...
{{text =news,url = "https://t.me/UWUWC"}, },}}
...
local UserId = msg.sender.user_id
local RinkBot = msg.Name_Controller
local TotalMsg = Redis:get(TheBekme..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,TheBekme).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,TheBekme).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✔️ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(TheBekme.."Bekme:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheBekme.."Bekme:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheBekme.."Bekme:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheBekme.."Bekme:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheBekme.."Bekme:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheBekme.."Bekme:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheBekme.."Bekme:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheBekme.."Bekme:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheBekme.."Bekme:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheBekme.."Bekme:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheBekme.."Bekme:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheBekme.."Bekme:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheBekme.."Bekme:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheBekme.."Bekme:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheBekme.."Bekme:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheBekme.."Bekme:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheBekme.."Bekme:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheBekme.."Bekme:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheBekme.."Bekme:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheBekme.."Bekme:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheBekme.."Bekme:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheBekme.."Bekme:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheBekme.."Bekme:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheBekme.."Bekme:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheBekme.."Bekme:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheBekme.."Bekme:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheBekme.."Bekme:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheBekme.."Bekme:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheBekme.."Bekme:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheBekme.."Bekme:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheBekme.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheBekme.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheBekme.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : الحمار هاذا بطل يصفن ").Reply,"md",true)  
else
Redis:srem(TheBekme.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "قرد" then
if not Redis:sismember(TheBekme.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheBekme.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheBekme.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheBekme.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "ملك" then
if not Redis:sismember(TheBekme.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheBekme.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheBekme.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheBekme.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheBekme.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : يارب تعقل وتبقا ذكي 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(TheBekme.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheBekme.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : اعقل بقا 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(TheBekme.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheBekme.."Bekme:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheBekme.."Bekme:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheBekme.."Bekme:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheBekme.."Bekme:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(TheBekme.."Bekme:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheBekme.."Bekme:Developers:Groups",UserId) 
...
if not Redis:sismember(TheBekme.."Bekme:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheBekme.."Bekme:TheBasicsW:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheBekme.."Bekme:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheBekme.."Bekme:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheBekme.."Bekme:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheBekme.."Bekme:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheBekme.."Bekme:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheBekme.."Bekme:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheBekme.."Bekme:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheBekme.."Bekme:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheBekme.."Bekme:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheBekme.."Bekme:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheBekme.."Bekme:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم ترقيته مطور بنجاح ✓ ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheBekme.."Bekme:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(TheBekme.."Bekme:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم ترقيته مطور بنجاح ✓ مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheBekme.."Bekme:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(TheBekme.."Bekme:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheBekme.."Bekme:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheBekme.."Bekme:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
...
Redis:sadd(TheBekme.."Bekme:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheBekme.."Bekme:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم ترقيته منشئ بنجاح ✓ مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheBekme.."Bekme:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheBekme.."Bekme:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم ترقيته مدير مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(TheBekme.."Bekme:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheBekme.."Bekme:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(TheBekme.."Bekme:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم ترقيته ادمن مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(TheBekme.."Bekme:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheBekme.."Bekme:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم ترقيته مميز مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(TheBekme.."Bekme:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheBekme.."Bekme:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheBekme.."Bekme:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheBekme.."Bekme:Developers:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheBekme.."Bekme:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheBekme.."Bekme:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheBekme.."Bekme:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheBekme.."Bekme:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheBekme.."Bekme:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم ترقيته منشئ اساسي بنجاح ✓").Reply,"md",true)  
end
end
if TextMsg == "منشئ" then
...
if Redis:sismember(TheBekme.."Bekme:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheBekme.."Bekme:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheBekme.."Bekme:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم ترقيته مدير مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(TheBekme.."Bekme:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheBekme.."Bekme:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم ترقيته ادمن مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(TheBekme.."Bekme:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم ترقيته ادمن بنجاح ✓  ").Reply,"md",true)  
end
end
if TextMsg == "كانسر" then
if ChannelJoin(msg) == false then
local chinfo = Redis:get(TheBekme.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(TheBekme..'Bekme:Channel:Join:Name')..'', url = 't.me/'..Redis:get(TheBekme..'Bekme:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n‹ : عمري اشترك ثم استخدم الامر*',"md",false, false, false, false, reply_markup)
end
if Redis:sismember(TheBekme.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheBekme.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheBekme.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheBekme.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheBekme.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheBekme.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheBekme.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheBekme.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheBekme.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheBekme.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheBekme.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheBekme.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheBekme.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheBekme.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheBekme.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheBekme.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheBekme.."Bekme:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم ترقيته مميز مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(TheBekme.."Bekme:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheBekme.."Bekme:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم ترقيته مطور بنجاح ✓ ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheBekme.."Bekme:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(TheBekme.."Bekme:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم ترقيته مطور بنجاح ✓ مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheBekme.."Bekme:Developers:Groups",UserId) 
...
if Redis:sismember(TheBekme.."Bekme:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheBekme.."Bekme:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheBekme.."Bekme:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم ترقيته منشئ بنجاح ✓اساسي بنجاح ✓ مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheBekme.."Bekme:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheBekme.."Bekme:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم ترقيته منشئ بنجاح ✓ مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheBekme.."Bekme:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheBekme.."Bekme:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم ترقيته مدير مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(TheBekme.."Bekme:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheBekme.."Bekme:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم ترقيته ادمن مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(TheBekme.."Bekme:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheBekme.."Bekme:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم ترقيته مميز مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(TheBekme.."Bekme:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(TheBekme.."Bekme:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(TheBekme.."Bekme:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheBekme.."Bekme:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheBekme.."Bekme:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(TheBekme.."Bekme:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheBekme.."Bekme:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(TheBekme.."Bekme:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(TheBekme.."Bekme:Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*‹ : قائمه مطورين البوت \n ⋆┄┄─┄─┄─┄┄─┄─┄┄⋆*\n'
...
local Info_Members = Redis:smembers(TheBekme.."Bekme:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheBekme.."Bekme:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : لا يوجد منشئين اساسيين حاليا , ","md",true)  
end
...
local Info_Members = Redis:smembers(TheBekme.."Bekme:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheBekme.."Bekme:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheBekme.."Bekme:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheBekme.."wtka:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheBekme.."mar:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheBekme.."2rd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheBekme.."klb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheBekme.."smb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheBekme.."kholat:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheBekme.."8by:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheBekme.."3ra:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheBekme.."Bekme:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheBekme.."Bekme:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheBekme.."Bekme:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheBekme.."Bekme:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(TheBekme.."Bekme:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(TheBekme.."Bekme:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(TheBekme.."Bekme:Status:Id"..msg_chat_id,true) 
...
Redis:set(TheBekme.."Bekme:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(TheBekme.."Bekme:Status:Reply"..msg_chat_id,true) 
...
Redis:set(TheBekme.."Bekme:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(TheBekme.."Bekme:Status:BanId"..msg_chat_id,true) 
...
Redis:set(TheBekme.."Bekme:BotFree",true) 
...
Redis:set(TheBekme.."Bekme:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(TheBekme.."Bekme1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(TheBekme.."Bekme1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheBekme.."Bekme1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheBekme.."Bekme1:List:Rd:Sudo"..msg.chat_id, text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(TheBekme.."Bekme1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(TheBekme..'Bekme1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(TheBekme..'Bekme1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(TheBekme..'Bekme1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(TheBekme.."Bekme1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheBekme.."Bekme1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(TheBekme.."Bekme1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(TheBekme.."Bekme1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(TheBekme.."Bekme1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(TheBekme.."Bekme1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(TheBekme.."Bekme1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(TheBekme.."Bekme1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(TheBekme.."Bekme1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TheBekme.."Bekme1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheBekme.."Bekme1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheBekme.."Bekme1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheBekme.."Bekme1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TheBekme.."Bekme1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheBekme.."Bekme1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheBekme.."Bekme1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheBekme.."Bekme1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TheBekme.."Bekme1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheBekme.."Bekme1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheBekme.."Bekme1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheBekme.."Bekme1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(TheBekme.."Bekme1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(TheBekme.."Bekme1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(TheBekme.."Bekme1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(TheBekme.."Bekme11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(TheBekme.."Bekme11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheBekme.."Bekme11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheBekme.."Bekme11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(TheBekme.."Bekme11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(TheBekme..'Bekme11:Add:Rd:Sudo:Text'..text)
Redis:del(TheBekme..'Bekme11:Add:Rd:Sudo:Text1'..text)
Redis:del(TheBekme..'Bekme11:Add:Rd:Sudo:Text2'..text)
Redis:del(TheBekme.."Bekme11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheBekme.."Bekme11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(TheBekme.."Bekme11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(TheBekme.."Bekme11:Add:Rd:Sudo:Text"..v) 
Redis:del(TheBekme.."Bekme11:Add:Rd:Sudo:Text1"..v) 
Redis:del(TheBekme.."Bekme11:Add:Rd:Sudo:Text2"..v)   
Redis:del(TheBekme.."Bekme11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(TheBekme.."Bekme11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(TheBekme.."Bekme11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TheBekme.."Bekme11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheBekme.."Bekme11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheBekme.."Bekme11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheBekme.."Bekme11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(TheBekme.."Bekme11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheBekme.."Bekme11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheBekme.."Bekme11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheBekme.."Bekme11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(TheBekme.."Bekme11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheBekme.."Bekme11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheBekme.."Bekme11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheBekme.."Bekme11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(TheBekme.."Bekme11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(TheBekme.."Bekme11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(TheBekme.."Bekme11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(TheBekme.."Bekme:allM"..msg.chat_id, msg.id)
if Redis:get(TheBekme.."Bekme:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(TheBekme.."Bekme:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(TheBekme.."Bekme:allM"..msg.chat_id)
...
Redis:del(TheBekme.."Bekme:allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(TheBekme.."Bekme:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(TheBekme.."Bekme:allM"..msg.chat_id)  
...
Redis:del(TheBekme.."Bekme:Status:Del:Media"..msg.chat_id)
...
Redis:set(TheBekme.."Bekme:Status:Del:Media"..msg.chat_id,true)
...
Redis:del(TheBekme.."Bekme:Status:yt"..msg.chat_id)
...
Redis:set(TheBekme.."Bekme:Status:yt"..msg.chat_id,true)
...
local httpsCurl = "http://185.185.127.158/Bekme/tahaj200.php?token="..Token.."&msg="..MsgId.."&Text="..URL.escape(Ttext).."&chat_id="..msg.chat_id.."&user="..msg.sender.user_id
...
if text == "غنيلي" then
Abs = math.random(2,140); 
local Text =" [‹ : تم اختيار الاغنيه لك : -](t.me/UWUWC)"
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == "شعر" then
Abs = math.random(2,140); 
local Text =" [‹ : تم اختيار الشعر لك :  ](t.me/UWUWC)"
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '‹ 𝘵𝘦𝘢𝘮 𝘣𝘦𝘬𝘮𝘢 › ',url="t.me/UWUWC"}
},
{
...
if text == "ميمز" then
Abs = math.random(2,140); 
local Text =" [متحركات Gٍٓif ᯓ ](t.me/UWUWC)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '‹ 𝘵𝘦𝘢𝘮 𝘣𝘦𝘬𝘮𝘢 › ',url="t.me/UWUWC"}},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/https://t.me/UWUWC/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local UserId_Info = LuaTele.searchPublicChat("UU7UD")
...
if photo.total_count > 0 then
local TestText = "  ‹ 𝘵𝘦𝘢𝘮 𝘣𝘦𝘬𝘮𝘢 › \n⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : *Dev Name* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n‹ : *Dev Bio* : [‹ "..Bio.."  ›]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = 'ᥲᥣsһ .', url = "https://t.me/UU7UD"}
},
{
{text = '‹ 𝘵𝘦𝘢𝘮 𝘣𝘦𝘬𝘮𝘢 › ', url='https://t.me/UWUWC'},
},
...
local UserId_Info = LuaTele.searchPublicChat("@UWUWC")
if UserId_Info.id then
local UserInfo = LuaTele.getUser(UserId_Info.id)
local InfoUser = LuaTele.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.Bekmechat.com%2Faccounts%2Fdeleteaccount"}},{{text= ' سورس بيكما',url="t.me/UWUWC"}}
}
local msg_id = msg.id/2097152/0.5
...
if text == "تاك للمطلقات" or text == "المطلقات" then
  local mutlqat_list = Redis:smembers(TheBekme..msg_chat_id.."mutlqat:")
...
keyboard.inline_keyboard = {
{
{text = 'T𝘸𝘴 ⁦𝘣𝘦𝘬𝘮𝘢', url = 'https://t.me/mrrtibot'},{text = '‹ 𝘵𝘦𝘢𝘮 𝘣𝘦𝘬𝘮𝘢 ›', url = 'https://t.me/UWUWC'}, 
},
{
{text = 'ᥲᥣsһ .', url = 't.me/UU7UD'}, 
},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/UWUWC&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "منو اني" then
if msg.sender.user_id == tonumber(1122282868) then
...
Redis:del(TheBekme.."Bekme:Status:joinet"..msg_chat_id) 
...
Redis:set(TheBekme.."Bekme:Status:joinet"..msg_chat_id,true) 
...
if TextMsg == 'الرابط' then
Redis:del(TheBekme.."Bekme:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(TheBekme.."Bekme:Status:Welcome"..msg_chat_id) 
...
Redis:del(TheBekme.."Bekme:Status:Id"..msg_chat_id) 
...
Redis:del(TheBekme.."Bekme:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(TheBekme.."Bekme:Status:Reply"..msg_chat_id) 
...
Redis:del(TheBekme.."Bekme:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(TheBekme.."Bekme:Status:BanId"..msg_chat_id) 
...
Redis:del(TheBekme.."Bekme:Status:SetId"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تعطيل الرفع ","md",true)
end
if TextMsg == 'الالعاب' then
Redis:del(TheBekme.."Bekme:Status:Games"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تعطيل الالعاب ","md",true)
end
if TextMsg == 'اطردني' then
Redis:del(TheBekme.."Bekme:Status:KickMe"..msg_chat_id) 
...
Redis:del(TheBekme.."Bekme:BotFree") 
...
Redis:del(TheBekme.."Bekme:TwaslBot") 
...
if Redis:sismember(TheBekme.."Bekme:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheBekme.."Bekme:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheBekme.."Bekme:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(TheBekme.."Bekme:BanAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheBekme.."Bekme:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(TheBekme.."Bekme:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(TheBekme.."Bekme:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
if not Redis:sismember(TheBekme.."Bekme:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheBekme.."Bekme:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheBekme.."Bekme:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(TheBekme.."Bekme:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if not Redis:sismember(TheBekme.."Bekme:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TheBekme.."Bekme:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
data = {
{
{text = '- الغاء الطرد', data = msg.sender.user_id..'/unbanktmkid@'..UserId_Info.id},
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم طرده من المجموعه سابقآ ✓ ").Reply,"md",true, false, false, false, reply_markup)
else
Redis:sadd(TheBekme.."Bekme:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
local reply_markup = LuaTele.replyMarkup{
...
if Redis:sismember(TheBekme.."Bekme:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheBekme.."Bekme:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheBekme.."Bekme:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheBekme.."Bekme:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheBekme.."Bekme:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheBekme.."Bekme:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(TheBekme.."Bekme:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheBekme.."Bekme:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheBekme.."Bekme:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheBekme.."Bekme:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheBekme.."Bekme:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheBekme.."Bekme:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TheBekme.."Bekme:BanGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(TheBekme.."Bekme:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(TheBekme.."Bekme:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheBekme.."Bekme:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheBekme.."Bekme:SilentGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(TheBekme.."Bekme:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(TheBekme.."Bekme:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TheBekme.."Bekme:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if not Redis:get(TheBekme.."Bekme:Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheBekme.."Bekme:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheBekme.."Bekme:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
if not msg.ControllerBot and not Redis:set(TheBekme.."Bekme:LeftBot") then
...
Redis:set(TheBekme.."Bekme:Lock:text"..msg_chat_id,true) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"‹ : تم قفـل الدردشه").Lock,"md",true)  
return false
end 
if text and Redis:get(TheBekme.."addchannel"..msg.sender.user_id) == "on" then
Redis:set(TheBekme.."chadmin"..msg_chat_id,text) 
LuaTele.sendText(msg_chat_id,msg_id,"𖥔  تم حفظ ايدي القناه","md",true)  
Redis:del(TheBekme.."addchannel"..msg.sender.user_id)
end
if text == "القناه المضافه" then
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TheBekme.."chadmin"..msg_chat_id),"md",true)  
end
if text == "اضف قناه" then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖥔 هاذا الامر يخص『 '..Controller_Num(7)..' 』* ',"md",true)  
end
Redis:set(TheBekme.."addchannel"..msg.sender.user_id,"on") 
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TheBekme..'Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n𖥔 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
Redis:set(TheBekme.."Lock:channell"..msg_chat_id,true) 
...
Redis:del(TheBekme.."Lock:channell"..msg_chat_id)  
...
Redis:set(TheBekme.."Bekme:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(TheBekme.."Bekme:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(TheBekme.."Bekme:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(TheBekme.."Bekme:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(TheBekme.."Bekme:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(TheBekme.."Bekme:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(TheBekme.."Bekme:Lock:edit"..msg_chat_id,true) 
...
Redis:set(TheBekme.."Bekme:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheBekme..'Bekme:'..lock..msg_chat_id,"del")    
end
...
Redis:del(TheBekme.."Bekme:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(TheBekme.."Bekme:Lock:text"..msg_chat_id)  
...
Redis:del(TheBekme.."Bekme:Lock:Join"..msg_chat_id)  
...
Redis:del(TheBekme.."Bekme:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(TheBekme.."Bekme:Lock:tagservr"..msg_chat_id)  
...
Redis:del(TheBekme.."Bekme:lockpin"..msg_chat_id)  
...
Redis:del(TheBekme.."Bekme:Lock:edit"..msg_chat_id) 
...
Redis:del(TheBekme.."Bekme:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(TheBekme..'Bekme:'..lock..msg_chat_id)    
end
...
Redis:hset(TheBekme.."Bekme:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(TheBekme.."Bekme:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(TheBekme.."Bekme:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(TheBekme.."Bekme:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(TheBekme.."Bekme:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(TheBekme.."Bekme:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(TheBekme.."Bekme:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(TheBekme.."Bekme:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(TheBekme.."Bekme:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(TheBekme.."Bekme:Lock:Link"..msg_chat_id)  
...
Redis:set(TheBekme.."Bekme:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(TheBekme.."Bekme:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(TheBekme.."Bekme:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(TheBekme.."Bekme:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(TheBekme.."Bekme:Lock:User:Name"..msg_chat_id)  
...
Redis:set(TheBekme.."Bekme:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(TheBekme.."Bekme:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(TheBekme.."Bekme:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(TheBekme.."Bekme:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(TheBekme.."Bekme:Lock:hashtak"..msg_chat_id)  
...
Redis:set(TheBekme.."Bekme:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(TheBekme.."Bekme:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(TheBekme.."Bekme:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(TheBekme.."Bekme:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(TheBekme.."Bekme:Lock:Cmd"..msg_chat_id)  
...
Redis:set(TheBekme.."Bekme:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(TheBekme.."Bekme:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(TheBekme.."Bekme:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(TheBekme.."Bekme:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:set(TheBekme.."Bekme:Lock:phshar"..msg_chat_id,true) 
...
Redis:set(TheBekme..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(TheBekme.."Bekme:Lock:phshar"..msg_chat_id)  
...
Redis:del(TheBekme..'lock:Fars'..msg.chat_id) 
...
Redis:del(TheBekme.."Bekme:Lock:Photo"..msg_chat_id)  
...
Redis:set(TheBekme.."Bekme:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(TheBekme.."Bekme:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(TheBekme.."Bekme:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(TheBekme.."Bekme:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(TheBekme.."Bekme:Lock:Video"..msg_chat_id)  
...
Redis:set(TheBekme.."Bekme:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(TheBekme.."Bekme:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(TheBekme.."Bekme:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(TheBekme.."Bekme:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(TheBekme.."Bekme:Lock:Animation"..msg_chat_id)  
...
Redis:set(TheBekme.."Bekme:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(TheBekme.."Bekme:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(TheBekme.."Bekme:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(TheBekme.."Bekme:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(TheBekme.."Bekme:Lock:geam"..msg_chat_id)  
...
Redis:set(TheBekme.."Bekme:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(TheBekme.."Bekme:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(TheBekme.."Bekme:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(TheBekme.."Bekme:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(TheBekme.."Bekme:Lock:Audio"..msg_chat_id)  
...
Redis:set(TheBekme.."Bekme:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(TheBekme.."Bekme:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(TheBekme.."Bekme:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(TheBekme.."Bekme:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(TheBekme.."Bekme:Lock:vico"..msg_chat_id)  
...
Redis:set(TheBekme.."Bekme:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(TheBekme.."Bekme:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(TheBekme.."Bekme:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(TheBekme.."Bekme:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(TheBekme.."Bekme:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(TheBekme.."Bekme:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(TheBekme.."Bekme:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(TheBekme.."Bekme:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(TheBekme.."Bekme:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(TheBekme.."Bekme:Lock:Sticker"..msg_chat_id)  
...
Redis:set(TheBekme.."Bekme:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(TheBekme.."Bekme:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(TheBekme.."Bekme:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(TheBekme.."Bekme:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(TheBekme.."Bekme:Lock:forward"..msg_chat_id)  
...
Redis:set(TheBekme.."Bekme:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(TheBekme.."Bekme:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(TheBekme.."Bekme:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(TheBekme.."Bekme:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(TheBekme.."Bekme:Lock:Document"..msg_chat_id)  
...
Redis:set(TheBekme.."Bekme:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(TheBekme.."Bekme:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(TheBekme.."Bekme:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(TheBekme.."Bekme:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(TheBekme.."Bekme:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(TheBekme.."Bekme:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(TheBekme.."Bekme:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(TheBekme.."Bekme:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(TheBekme.."Bekme:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(TheBekme.."Bekme:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(TheBekme.."Bekme:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(TheBekme.."Bekme:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(TheBekme.."Bekme:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(TheBekme.."Bekme:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(TheBekme.."Bekme:Lock:Contact"..msg_chat_id)  
...
Redis:set(TheBekme.."Bekme:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(TheBekme.."Bekme:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(TheBekme.."Bekme:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(TheBekme.."Bekme:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(TheBekme.."Bekme:Lock:Spam"..msg_chat_id)  
...
Redis:set(TheBekme.."Bekme:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(TheBekme.."Bekme:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(TheBekme.."Bekme:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(TheBekme.."Bekme:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(TheBekme.."Bekme:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(TheBekme.."Bekme:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(TheBekme.."Bekme:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(TheBekme.."Bekme:Status:Link"..msg_chat_id) then
...
return LuaTele.sendText(msg_chat_id, msg_id, "‹ : اهلآ عرِ࣪يزي اختر نوع الرابط !  ", 'md', true, false, false, false, reply_markup)
end
...
Redis:setex(TheBekme.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(TheBekme.."Bekme:Status:Welcome"..msg_chat_id) then
...
Redis:del(TheBekme.."Bekme:Welcome:Group"..msg_chat_id) 
...
Redis:setex(TheBekme.."Bekme:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(TheBekme.."Bekme:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(TheBekme.."Bekme:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(TheBekme.."Bekme:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TheBekme.."Bekme:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(TheBekme.."Bekme:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(TheBekme.."Bekme:Filter:Group:"..v..msg_chat_id)  
Redis:srem(TheBekme.."Bekme:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(TheBekme.."Bekme:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(TheBekme..'Bekme:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(TheBekme..'Bekme:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*‹ : ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(TheBekme.."Bekme:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(TheBekme.."Bekme:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(TheBekme.."Bekme:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(TheBekme.."Bekme:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(TheBekme.."Bekme:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(TheBekme.."Bekme:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
if Redis:get(TheBekme.."Bekme:Status:Link"..msg.chat_id) then
Statuslink = '❬ ✔️ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(TheBekme.."Bekme:Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(TheBekme.."Bekme:Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(TheBekme.."Bekme:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if Redis:get(TheBekme.."Bekme:Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if Redis:get(TheBekme.."Bekme:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(TheBekme.."Bekme:Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(TheBekme.."Bekme:Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(TheBekme.."Bekme:Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(TheBekme.."Bekme:Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(TheBekme.."Bekme:Status:AddMe"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(TheBekme.."Bekme:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TheBekme.."Bekme:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(TheBekme.."Bekme:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(TheBekme.."Bekme:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(TheBekme.."Bekme:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(TheBekme.."Bekme:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(TheBekme.."Bekme:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(TheBekme.."Bekme:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(TheBekme.."Bekme:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(TheBekme.."Bekme:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(TheBekme.."Bekme:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(TheBekme.."Bekme:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(TheBekme..'Bekme:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(TheBekme..'Bekme:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(TheBekme..'Bekme:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'‹ : عدد رسائلك هنا *~ '..(Redis:get(TheBekme..'Bekme:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'‹ : عدد التعديلات هنا *~ '..(Redis:get(TheBekme..'Bekme:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'‹ : عدد جهاتك المضافه هنا *~ '..(Redis:get(TheBekme.."Bekme:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(TheBekme.."Bekme:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
‹ : ارسل الان النص
‹ : يمكنك اضافه :
...
Redis:del(TheBekme.."Bekme:Set:Id:Group"..msg.chat_id)
...
Redis:del(TheBekme.."Bekme:DevelopersQ:Groups") 
...
Redis:del(TheBekme.."Bekme:Developers:Groups") 
...
Redis:del(TheBekme.."Bekme:TheBasicsQ:Group"..msg_chat_id) 
...
Redis:del(TheBekme.."Bekme:TheBasics:Group"..msg_chat_id) 
...
Redis:del(TheBekme.."Bekme:Originators:Group"..msg_chat_id) 
...
Redis:del(TheBekme.."Bekme:Managers:Group"..msg_chat_id) 
...
Redis:del(TheBekme.."Bekme:Addictive:Group"..msg_chat_id) 
...
Redis:del(TheBekme.."Bekme:Distinguished:Group"..msg_chat_id) 
...
Redis:del(TheBekme.."Bekme:BanAll:Groups") 
...
Redis:del(TheBekme.."Bekme:BanGroup:Group"..msg_chat_id) 
...
Redis:del(TheBekme.."Bekme:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(TheBekme.."Bekme:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(TheBekme.."Bekme:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(TheBekme.."Bekme:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(TheBekme.."Bekme:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(TheBekme.."Bekme:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(TheBekme.."Bekme:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(TheBekme.."Bekme:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(TheBekme.."Bekme:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(TheBekme.."Bekme:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(TheBekme.."Bekme:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(TheBekme.."Bekme:List:Manager"..msg_chat_id)
end
...
for k,v in pairs(list) do
if Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(TheBekme.."Bekme:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ‹ : "
elseif Redis:get(TheBekme.."Bekme:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(TheBekme.."Bekme:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(TheBekme.."Bekme:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheBekme.."Bekme:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(TheBekme.."Bekme:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(TheBekme.."Bekme:Add:Rd:Sudo:Gif"..v)   
Redis:del(TheBekme.."Bekme:Add:Rd:Sudo:vico"..v)   
Redis:del(TheBekme.."Bekme:Add:Rd:Sudo:stekr"..v)     
Redis:del(TheBekme.."Bekme:Add:Rd:Sudo:Text"..v)   
Redis:del(TheBekme.."Bekme:Add:Rd:Sudo:Photo"..v)
Redis:del(TheBekme.."Bekme:Add:Rd:Sudo:Video"..v)
Redis:del(TheBekme.."Bekme:Add:Rd:Sudo:File"..v)
Redis:del(TheBekme.."Bekme:Add:Rd:Sudo:Audio"..v)
Redis:del(TheBekme.."Bekme:Add:Rd:Sudo:video_note"..v)
Redis:del(TheBekme.."Bekme:List:Rd:Sudo")
end
...
text = "\n📝︙قائمة ردود المطور \n⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n"
for k,v in pairs(list) do
if Redis:get(TheBekme.."Bekme:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(TheBekme.."Bekme:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(TheBekme.."Bekme:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(TheBekme.."Bekme:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(TheBekme.."Bekme:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(TheBekme.."Bekme:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(TheBekme.."Bekme:Add:Rd:Sudo:File"..v) then
db = "ملف ‹ : "
elseif Redis:get(TheBekme.."Bekme:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(TheBekme.."Bekme:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(TheBekme.."Bekme:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheBekme.."Bekme:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:setex(TheBekme.."Bekme:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
‹ : ارسل لي سواء كان 
❨ ملف ‹ : ملصق ‹ : متحركه ‹ : صوره
 ‹ : فيديو ‹ : بصمه الفيديو ‹ : بصمه ‹ : صوت ‹ : رساله ❩
...
Redis:setex(TheBekme.."Bekme:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
‹ : ارسل لي سواء كان 
❨ ملف ‹ : ملصق ‹ : متحركه ‹ : صوره
 ‹ : فيديو ‹ : بصمه الفيديو ‹ : بصمه ‹ : صوت ‹ : رساله ❩
...
Redis:setex(TheBekme.."Bekme:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
‹ : ارسل لي سواء كان 
❨ ملف ‹ : ملصق ‹ : متحركه ‹ : صوره
 ‹ : فيديو ‹ : بصمه الفيديو ‹ : بصمه ‹ : صوت ‹ : رساله ❩
...
Redis:setex(TheBekme.."Bekme:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(TheBekme.."Bekme:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TheBekme..'Bekme:GetTexting:DevTheBekme'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TheBekme..'Bekme:Texting:DevTheBekme')
...
{
{text = 'اوامر المطورين', data = msg.sender.user_id..'/help5'}, {text = 'اوامر التحشيش', data = msg.sender.user_id..'/help7'},
},
{
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(theBekme..'Bekme:Channel:Join:Name')..'', url = 't.me/'..Redis:get(theBekme..'Bekme:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n‹ : عذرا عمري عليك الاشتراك بقناه البوت -*',"md",false, false, false, false, reply_markup)
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
Redis:setex(TheBekme.."Bekme:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TheBekme.."Bekme:Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(TheBekme.."Bekme:Name:Bot") or "بيكما") then
local NamesBot = (Redis:get(TheBekme.."Bekme:Name:Bot") or "بيكما")
local NameBots = {
"يروح "..NamesBot.. " كول؟",
"انا "..NamesBot.. " القميل",
"هاعمري",
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 'https://t.me/UWUWC'}, 
},
{
...
local BotName = {
"الحمد لله ونته",
"على قول @UU7UD ع الباري ونتَ",
"انا بخير",
}
return LuaTele.sendText(msg_chat_id,msg_id,BotName[math.random(#BotName)],"md",true)   
end
if text == "بوسه" then
local NamesBot = (Redis:get(TheBekme.."Bekme:Name:Bot") or "Bekme")
local BotName = {
"اهممممواح🙈😉.",
"عيع خدك وصخ 😹🏃‍♀️.",
"اوفف اخدر اذاابوسه 🙈😻.",
...
send(msg_chat_id,msg_id,'مِہטּ نورڪ ؏ـمري 💞🥳','md')
elseif text == "هاي" then LuaTele.sendText(msg_chat_id,msg_id,'هـايـات يلصاڪ نـورتـنـا💘','md')
elseif text == "هلو" then LuaTele.sendText(msg_chat_id,msg_id,'هـايـات يلصاڪ نـورتـنـا💘','md')
elseif text == "تمام"then LuaTele.sendText(msg_chat_id,msg_id,'تـدوم يروحي💗','md')
elseif text == "فرخ" then LuaTele.sendText(msg_chat_id,msg_id,'ويـنـه بـلـه خـل حـصـره😹🤤 ','md')
elseif text == "وينك"then LuaTele.sendText(msg_chat_id,msg_id,'دور بڪلبڪ وتلڪانيہ ♥️🥵','md')
...
elseif text == "😒" then LuaTele.sendText(msg_chat_id,msg_id,'شـبيڪ عمريي مـنـو مـضـوجڪ😣💘','md')
elseif text == "🙁" then LuaTele.sendText(msg_chat_id,msg_id,'تـعال عمري تـعـال شڪيلي همومڪ😦💘','md')
...
elseif text == "🌝" then LuaTele.sendText(msg_chat_id,msg_id,'مـنـورر عمريي طـالع تـخـبل😻💘','md')
elseif text == "😌" then LuaTele.sendText(msg_chat_id,msg_id,'والمـطـلـوب شرايد😤💘','md')
elseif text == "😋" then LuaTele.sendText(msg_chat_id,msg_id,"طببہ لسانڪ جوهہ ؏ـيبہ 🥳😹✌🏻",'md')
elseif text == "😡" then LuaTele.sendText(msg_chat_id,msg_id,"ابرد 🚒"  ,'md')
...
elseif text == "🙄" then LuaTele.sendText(msg_chat_id,msg_id,"نـزل عيونڪ عمريي😿💘",'md')
elseif text == "😹" or text == "😹😹"then LuaTele.sendText(msg_chat_id,msg_id,"فـدوا هـل ضحڪه💘",'md')
elseif text == "😹😹😹" then LuaTele.sendText(msg_chat_id,msg_id,"ضڪه ترد روح دايـمه عمغريي🙈💘",'md')
elseif text == "🙈" then LuaTele.sendText(msg_chat_id,msg_id,"ه̷̷ـذآ ويهگ لو خليـﮫۂ مال ﻋسل 🍯🤤",'md')
elseif text == "🚶🏻‍♂"then LuaTele.sendText(msg_chat_id,msg_id,"ويـن رايح عمريي تـعـال🥺💘",'md')
elseif text == "😢" or text =="😭" then LuaTele.sendText(msg_chat_id,msg_id,'لتبجيہ حياتيہ 🥺😭💞','md')
elseif text == "لتزحف"then LuaTele.sendText(msg_chat_id,msg_id,'شـعليڪ بـي عمريي خـلي يـزحف ☹️','md')
elseif text == "كلخرا"then LuaTele.sendText(msg_chat_id,msg_id,'اسـف عمريي مـا خليڪ بـحـلڪي','md')
elseif text == "عوائل"then LuaTele.sendText(msg_chat_id,msg_id,'حـبيـبي ولله ربـط فـيـشه ويـانـا🙈💋','md')
elseif text == "صايره عوائل"then LuaTele.sendText(msg_chat_id,msg_id,'عمريي الـحلـو انـي ويـاڪ نـسـولف🥺😻','md')
elseif text == "انت منو"then LuaTele.sendText(msg_chat_id,msg_id,'اني بـوت عمريي🙊','md')
elseif text == "اوف"then LuaTele.sendText(msg_chat_id,msg_id,'اوف يـروحـي شبيڪ ضـايـج🥺','md')
elseif text == "شكو"then LuaTele.sendText(msg_chat_id,msg_id,'ڪلـشي ماڪو رجع نام عمريي☹️','md')
elseif text == "كافي لغوة" or text == " شكد تحجي"then LuaTele.sendText(msg_chat_id,msg_id,'ولله بڪيفية انـت شـعـليڪ😏💘','md')
elseif text == "وين"then LuaTele.sendText(msg_chat_id,msg_id,'بارض الله الـواسـعـه💘','md')
elseif text == "حاره" or text == "حارة"then LuaTele.sendText(msg_chat_id,msg_id,'اي ولله ڪلش حـارا🥺💋','md')
elseif text == "غلس"then LuaTele.sendText(msg_chat_id,msg_id,'ماغلـس لـو تـمـوت😗💘','md')
elseif text == "شوف"then LuaTele.sendText(msg_chat_id,msg_id,'شـشـوف عمريي😳','md')
elseif text == "اها"then LuaTele.sendText(msg_chat_id,msg_id,'قـابـل غشڪ عمريي💋😽','md')
elseif text == "كفو"then LuaTele.sendText(msg_chat_id,msg_id,'ڪـفـو مـنڪ عمريي💘','md')
elseif text == "انجب" or text == "نجب"then LuaTele.sendText(msg_chat_id,msg_id,'صـار عمريي💘🥺','md')
elseif text == "منور" then LuaTele.sendText(msg_chat_id,msg_id,'نِْـِْـــِْ([💡])ِْــــًِـًًْـــِْـِْـِْـورِْكِْ','md')
elseif text == "شكرا" then LuaTele.sendText(msg_chat_id,msg_id,'ادلل يــ؏ـمريي ،🖤','md')
elseif text == "اكرهج" or text =="اكرهك" then LuaTele.sendText(msg_chat_id,msg_id,'عـساس انـي مـيـت بيڪڪ دمـشـي لڪ😿😹','md')
elseif text == "اريد اكبل" then LuaTele.sendText(msg_chat_id,msg_id,'خخ انيہ ۿم اريد اڪبل قابلہ ربيہ وحد 🥵🥳😹','md')
...
elseif text == "صاك" then LuaTele.sendText(msg_chat_id,msg_id,'زاحفۿ منو هذهہ دزيليہ صورتهہ 🥵😹💓','md')
elseif text == "افلش" or text =="حفلش" then LuaTele.sendText(msg_chat_id,msg_id,'افلشہ راسڪ🔥','md')
elseif text == "نايمين" then LuaTele.sendText(msg_chat_id,msg_id,'سـهران حـرسـڪم🤕','md')
elseif text == "اكو واحد" then LuaTele.sendText(msg_chat_id,msg_id,'اي عمريي انـي مـوجود 🌝','md')
elseif text == "شكو" then LuaTele.sendText(msg_chat_id,msg_id,'ڪلشيہ وڪلاشييہ تڪول احنۿ بالشورجه 😹🥳🔥','md')
...
elseif text == "السلام عليكم" then LuaTele.sendText(msg_chat_id,msg_id,"و؏ـليڪم الــسلام ؏ــمـريـہ 💞🥺",'md')
elseif text == "جوعان" then LuaTele.sendText(msg_chat_id,msg_id,"تعاࢦ اڪلنيہ 😹💞",'md')
elseif text == "خاصك" then LuaTele.sendText(msg_chat_id,msg_id,"سهلهہ الغرڪ ب المايہ بيدڪ تطلعهہ بسہ الغرڪ ب الخاصہ ڪليہ شيطلعهہ 👊🏽😹🥳",'md')
...
elseif text == "احبج" then LuaTele.sendText(msg_chat_id,msg_id,"جـذاب ترا يـضـحڪ علـيـج😼💘",'md')
elseif text == "شكو ماكو" then LuaTele.sendText(msg_chat_id,msg_id,"غيرڪ ـ ج ب الڪلبہ ماڪو 🥺💓",'md')
elseif text == "مرحبا" then LuaTele.sendText(msg_chat_id,msg_id,"مراحب يـعمري 🤤💞",'md')
...
elseif text == "عضه" then LuaTele.sendText(msg_chat_id,msg_id,"شڪلولڪ عࢦيهۃ جلبہ؟ انتہ روح ؏ـضهہ 😹🐕" ,'md')
...
elseif text == "ممكن خاص" then LuaTele.sendText(msg_chat_id,msg_id,"اطرد 🥵😹",'md')
...
elseif text == "مرتبطه" then LuaTele.sendText(msg_chat_id,msg_id,"مرتبطهۃ بالدراسهہ",'md')
...
elseif text == "فديتك" or text == "فديت" or text == "فديتج"then LuaTele.sendText(msg_chat_id,msg_id,"حـبـيبـي ولله فـداڪ عمري" ,'md')
elseif text == "مساعدة" then LuaTele.sendText(msg_chat_id,msg_id,"لعرض قائمة المساعدة اكتب الاوامر 🌚❤️",'md')
elseif text == "زاحف" then LuaTele.sendText(msg_chat_id,msg_id,"زاحفہ ؏ خالتڪ الشڪره 😹👊🏽",'md')
...
elseif text == "ورده" or text == "وردة"then LuaTele.sendText(msg_chat_id,msg_id,"انتہ ـ ي عطرها 💞🌝",'md')
...
elseif text == "حبيبي" or text =="حبي"then LuaTele.sendText(msg_chat_id,msg_id,"بـ؏ـد روحيہ تفضل 🥺♥️",'md')
...
elseif text == "دي"  or text == "ديي"then LuaTele.sendText(msg_chat_id,msg_id,"امـشـيڪ بـيها عمريي😗😹 ",'md')
...
elseif text == "اني" then LuaTele.sendText(msg_chat_id,msg_id,"الــخيل ولــبيداء يـعرفڪ مــو",'md')
...
x = x + 1
Redis:srem(TheBekme..'Bekme:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,TheBekme)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*‹ : البوت عظو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(TheBekme..'Bekme:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(TheBekme..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(TheBekme..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(TheBekme..'Bekme:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(TheBekme.."Bekme:Game:Smile"..msg.chat_id,SM)
...
local bank_users = Redis:smembers(TheBekme.."zrfffidtf")
...
local mony = Redis:get(TheBekme.."zrffdcf"..v) or 0
...
if num <= 25 then
fne = Redis:get(TheBekme..':toob:Name:'..v[2])
tt =  "["..fne.."]("..fne..")"
local mony = v[1]
local emo = emoji[k]
num = num + 1
...
ballancee = Redis:get(TheBekme.."nool:flotysb"..msg.sender.user_id) or 0
local bank_users = Redis:smembers(TheBekme.."ttpppi")
if #bank_users == 0 then
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(TheBekme.."nool:flotysb"..v) or 0
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
local bank_users = Redis:smembers(TheBekme.."almtzog"..msg_chat_id)
if #bank_users == 0 then
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(TheBekme.."mznom"..msg_chat_id..v) 
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
for k,v in pairs(mony_list) do
if num <= 10 then
local zwga_id = Redis:get(TheBekme..msg_chat_id..v[2].."rgalll2:")
local user_name = LuaTele.getUser(v[2]).first_name
fne = Redis:get(TheBekme..':toob:Name:'..zwga_id)
fnte = Redis:get(TheBekme..':toob:Name:'..v[2])
...
if tonumber(Message_Reply.sender.user_id) == tonumber(TheBekme) then
return LuaTele.sendText(msg.chat_id,msg.id, "• غبي تبي تتزوج بوت!\n","md",true)
end
if Redis:get(TheBekme..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = Redis:get(TheBekme..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(TheBekme..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local albnt = LuaTele.getUser(zoog2)
fne = Redis:get(TheBekme..':toob:Name:'..zoog2)
albnt = "["..fne.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"• الحق ي : "..albnt.." زوجك يبي يتزوج ","md")
end
if Redis:get(TheBekme..msg_chat_id..msg.sender.user_id.."bnttt2:") then
local zwga_id = Redis:get(TheBekme..msg_chat_id..msg.sender.user_id.."bnttt2:") 
local zoog2 = Redis:get(TheBekme..msg_chat_id..zwga_id.."rgalll2:") 
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if Redis:get(TheBekme..msg_chat_id..Message_Reply.sender.user_id.."rgalll2:") or Redis:get(TheBekme..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:") then
...
local zwga_id = Redis:get(TheBekme..msg_chat_id..msg.sender.user_id.."bnttt2:") 
Redis:set(TheBekme..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:", msg.sender.user_id)
Redis:set(TheBekme..msg_chat_id..msg.sender.user_id.."rgalll2:", Message_Reply.sender.user_id)
Redis:set(TheBekme..msg_chat_id..Message_Reply.sender.user_id.."mhrrr2:", UserNameyy)
Redis:set(TheBekme..msg_chat_id..msg.sender.user_id.."mhrrr2:", UserNameyy)
...
Redis:decrby(TheBekme.."nool:flotysb"..msg.sender.user_id , UserNameyy)
Redis:incrby(TheBekme.."nool:flotysb"..Message_Reply.sender.user_id , UserNameyy)
Redis:incrby(TheBekme.."mznom"..msg_chat_id..msg.sender.user_id , UserNameyy)
Redis:sadd(TheBekme.."almtzog"..msg_chat_id,msg.sender.user_id)
...
if text == "زواجي" then
if not Redis:get(TheBekme..msg_chat_id..msg.sender.user_id.."rgalll2:") and not Redis:get(TheBekme..msg_chat_id..msg.sender.user_id.."bnttt2:") then
return LuaTele.sendText(msg_chat_id,msg_id,"انت اعزب","md")
end
if Redis:get(TheBekme..msg_chat_id..msg.sender.user_id.."bnttt2:") then
local zwga_id = Redis:get(TheBekme..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(TheBekme..msg_chat_id..zwga_id.."rgalll2:") 
local mhrr = Redis:get(TheBekme..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = LuaTele.getUser(zwga_id)
fne = Redis:get(TheBekme..':toob:Name:'..zwga_id)
alzog = "["..fne.."](tg://user?id="..zwga_id..") "
local albnt = LuaTele.getUser(zoog2)
fnte = Redis:get(TheBekme..':toob:Name:'..zoog2)
albnt = "["..fnte.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"• عقد زواجكم\n• الزوج : "..alzog.."\n• الزوجه : "..albnt.." \n• المهر : "..mhrr.." دولار ","md")
end
if Redis:get(TheBekme..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = Redis:get(TheBekme..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(TheBekme..msg_chat_id..zwga_id.."bnttt2:") 
local mhrr = Redis:get(TheBekme..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = LuaTele.getUser(zwga_id)
fnte = Redis:get(TheBekme..':toob:Name:'..zwga_id)
albnt = "["..fnte.."](tg://user?id="..zwga_id..") "
local gg = LuaTele.getUser(zoog2)
fntey = Redis:get(TheBekme..':toob:Name:'..zoog2)
...
if Redis:sismember(TheBekme.."noooybgy",yemsg.sender.user_id) then
cccc = Redis:get(TheBekme.."noolb"..yemsg.sender.user_id)
gg = Redis:get(TheBekme.."nnonb"..yemsg.sender.user_id)
uuuu = Redis:get(TheBekme.."nnonbn"..yemsg.sender.user_id)
pppp = Redis:get(TheBekme.."zrffdcf"..yemsg.sender.user_id) or 0
ballancee = Redis:get(TheBekme.."nool:flotysb"..yemsg.sender.user_id) or 0
...
if text == "خلع" then
if not Redis:get(TheBekme..msg_chat_id..msg.sender.user_id.."bnttt2:") then
...
alzog = " "..gg.first_name.." "
local zwga_id = Redis:get(TheBekme..msg_chat_id..msg.sender.user_id.."bnttt2:") 
Redis:incrby(TheBekme.."nool:flotysb"..zwga_id,mhrr)
Redis:decrby(TheBekme.."nool:flotysb"..msg.sender.user_id,mhrr)
Redis:del(TheBekme.."mznom"..msg_chat_id..zwga_id)
Redis:srem(TheBekme.."almtzog"..msg_chat_id,zwga_id)
Redis:del(TheBekme.."mznom"..msg_chat_id..msg.sender.user_id)
Redis:srem(TheBekme.."almtzog"..msg_chat_id,msg.sender.user_id)
Redis:del(TheBekme..msg_chat_id..msg.sender.user_id.."mhrrr2:")
Redis:del(TheBekme..msg_chat_id..zwga_id.."mhrrr2:")
Redis:del(TheBekme..msg_chat_id..msg.sender.user_id.."bnttt2:")
Redis:del(TheBekme..msg_chat_id..zwga_id.."bnttt2:")
Redis:del(TheBekme..msg_chat_id..msg.sender.user_id.."rgalll2:")
Redis:del(TheBekme..msg_chat_id..zwga_id.."rgalll2:")
LuaTele.sendText(msg_chat_id,msg_id,"• تم خلعت زوجك "..alzog.." \n ورجعت له "..mhrr.." دولار","md")
end
if text == "طلاق"  then
if not Redis:get(TheBekme..msg_chat_id..msg.sender.user_id.."rgalll2:") then
...
balas = 0
if Redis:sismember(TheBekme.."noooybgy",msg.sender.user_id) then
return LuaTele.sendText(msg.chat_id,msg.id, "• لديك حساب بنكي مسبقاً\n\n• لعرض معلومات حسابك اكتب\n↤︎ `حسابي`","md",true)
end
Redis:setex(TheBekme.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
...
if Redis:get(TheBekme.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) then
...
gg = "والت كارد ."
flossst = Redis:get(TheBekme.."nool:flotysb"..msg.sender.user_id) or 0
local banid = msg.sender.user_id
Redis:set(TheBekme.."nonna"..msg.sender.user_id,news)
Redis:set(TheBekme.."noolb"..msg.sender.user_id,creditcc)
Redis:set(TheBekme.."nnonb"..msg.sender.user_id,text)
Redis:set(TheBekme.."nnonbn"..msg.sender.user_id,gg)
Redis:set(TheBekme.."nonallname"..creditcc,news)
Redis:set(TheBekme.."nonallbalc"..creditcc,balas)
Redis:set(TheBekme.."nonallcc"..creditcc,creditcc)
Redis:set(TheBekme.."nonallban"..creditcc,text)
Redis:set(TheBekme.."nonallid"..creditcc,banid)
Redis:sadd(TheBekme.."noooybgy",msg.sender.user_id)
Redis:del(TheBekme.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
local banid = msg.sender.user_id
Redis:set(TheBekme.."nonna"..msg.sender.user_id,news)
Redis:set(TheBekme.."noolb"..msg.sender.user_id,creditvi)
Redis:set(TheBekme.."nnonb"..msg.sender.user_id,text)
Redis:set(TheBekme.."nnonbn"..msg.sender.user_id,gg)
Redis:set(TheBekme.."nonallname"..creditvi,news)
Redis:set(TheBekme.."nonallbalc"..creditvi,balas)
Redis:set(TheBekme.."nonallcc"..creditvi,creditvi)
Redis:set(TheBekme.."nonallban"..creditvi,text)
Redis:set(TheBekme.."nonallid"..creditvi,banid)
Redis:sadd(TheBekme.."noooybgy",msg.sender.user_id)
Redis:del(TheBekme.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
local banid = msg.sender.user_id
Redis:set(TheBekme.."nonna"..msg.sender.user_id,news)
Redis:set(TheBekme.."noolb"..msg.sender.user_id,creditex)
Redis:set(TheBekme.."nnonb"..msg.sender.user_id,text)
Redis:set(TheBekme.."nnonbn"..msg.sender.user_id,gg)
Redis:set(TheBekme.."nonallname"..creditex,news)
Redis:set(TheBekme.."nonallbalc"..creditex,balas)
Redis:set(TheBekme.."nonallcc"..creditex,creditex)
Redis:set(TheBekme.."nonallban"..creditex,text)
Redis:set(TheBekme.."nonallid"..creditex,banid)
Redis:sadd(TheBekme.."noooybgy",msg.sender.user_id)
Redis:del(TheBekme.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:sismember(TheBekme.."noooybgy",msg.sender.user_id) then
Redis:srem(TheBekme.."noooybgy", msg.sender.user_id)
Redis:del(TheBekme.."noolb"..msg.sender.user_id)
Redis:del(TheBekme.."zrffdcf"..msg.sender.user_id)
Redis:srem(TheBekme.."zrfffidtf", msg.sender.user_id)
...
if msg.ControllerBot then
local bank_users = Redis:smembers(TheBekme.."noooybgy")
for k,v in pairs(bank_users) do
Redis:del(TheBekme.."nool:flotysb"..v)
Redis:del(TheBekme.."zrffdcf"..v)
Redis:del(TheBekme.."innoo"..v)
Redis:del(TheBekme.."nnooooo"..v)
Redis:del(TheBekme.."nnoooo"..v)
Redis:del(TheBekme.."nnooo"..v)
Redis:del(TheBekme.."nnoo"..v)
Redis:del(TheBekme.."polic"..v)
Redis:del(TheBekme.."ashmvm"..v)
Redis:del(TheBekme.."hrame"..v)
Redis:del(TheBekme.."test:mmtlkat6"..v)
Redis:del(TheBekme.."zahbmm2"..v)
end
Redis:del(TheBekme.."ttpppi")
...
ballanceed = Redis:get(TheBekme.."nool:flotysb"..Remsg.sender.user_id) or 0
...
if Redis:sismember(TheBekme.."noooybgy",msg.sender.user_id) then
cccc = Redis:get(TheBekme.."noolb"..msg.sender.user_id)
gg = Redis:get(TheBekme.."nnonb"..msg.sender.user_id)
uuuu = Redis:get(TheBekme.."nnonbn"..msg.sender.user_id)
pppp = Redis:get(TheBekme.."zrffdcf"..msg.sender.user_id) or 0
ballancee = Redis:get(TheBekme.."nool:flotysb"..msg.sender.user_id) or 0
LuaTele.sendText(msg.chat_id,msg.id, "• الاسم ↢ "..news.."\n• الحساب ↢ `"..cccc.."`\n• بنك ↢ ( "..gg.." )\n• نوع ↢ ( "..uuuu.." )\n• الرصيد ↢ ( "..ballancee.." دولار 💸 )\n• الزرف ( "..pppp.." دولار ?? )\n-","md",true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
...
if text == 'مضاربه' then
if Redis:get(TheBekme.."nnooooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheBekme.."nnooooo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:decrby(TheBekme.."nool:flotysb"..msg.sender.user_id , ballanceekku)
Redis:setex(TheBekme.."nnooooo" .. msg.sender.user_id,1200, true)
...
ballanceekku = math.floor(coniss / 100 * modarbaa)
ballanceekkku = math.floor(ballancee + ballanceekku)
Redis:incrby(TheBekme.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekku))
Redis:setex(TheBekme.."nnooooo" .. msg.sender.user_id,1200, true)
...
if Redis:get(TheBekme.."nnoooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheBekme.."nnoooo" .. msg.sender.user_id)
rr = oger(check_time)
...
if Redis:get(TheBekme.."xxxr" .. msg.sender.user_id) then
ballanceekk = math.floor(coniss / 100 * 10)
ballanceekkk = math.floor(ballancee + ballanceekk)
Redis:incrby(TheBekme.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekk))
Redis:sadd(TheBekme.."ttpppi",msg.sender.user_id)
Redis:setex(TheBekme.."nnoooo" .. msg.sender.user_id,1200, true)
...
Redis:del(TheBekme.."nool:flotysb"..msg.sender.user_id)
...
if text == 'حظ' then
if Redis:get(TheBekme.."nnooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheBekme.."nnooo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:incrby(TheBekme.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceek))
Redis:setex(TheBekme.."nnooo" .. msg.sender.user_id,200, true)
...
ff = Redis:get(TheBekme.."nool:flotysb"..msg.sender.user_id)
...
Redis:decrby(TheBekme.."nool:flotysb"..msg.sender.user_id , coniss)
Redis:setex(TheBekme.."nnooo" .. msg.sender.user_id,200, true)
ff = Redis:get(TheBekme.."nool:flotysb"..msg.sender.user_id) or 0
...
Redis:set('TheBekme:'..bot_id..'idgem:user'..msg.chat_id_,taha)  
Redis:setex('TheBekme:'..bot_id.."gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
Redis:incrby('TheBekme:'..bot_id..'add:F'..msg.chat_id_..result.sender_user_id_,F)  
Redis:incrby('TheBekme:'..bot_id..'add:Fall'..msg.chat_id_..result.sender_user_id_,F)  
...
local coniss = coniss:gsub('٩','9')
local coniss = tonumber(coniss)
if not Redis:sismember(TheBekme.."noooybgy",msg.sender.user_id) then
return LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ","md",true)
end
if Redis:get(TheBekme.."polici" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheBekme.."polici" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:set(TheBekme.."transn"..msg.sender.user_id,coniss)
Redis:setex(TheBekme.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
LuaTele.sendText(msg.chat_id,msg.id,[[
...
if Redis:get(TheBekme.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) then
cccc = Redis:get(TheBekme.."noolb"..msg.sender.user_id)
gg = Redis:get(TheBekme.."nnonb"..msg.sender.user_id)
uuuu = Redis:get(TheBekme.."nnonbn"..msg.sender.user_id)
if text ~= text:match('^(%d+)$') then
Redis:del(TheBekme.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) 
Redis:del(TheBekme.."transn" .. msg.sender.user_id)
...
if Redis:get(TheBekme.."nonallcc"..text) then
local UserNamey = Redis:get(TheBekme.."transn"..msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
...
local fsvhhh = Redis:get(TheBekme.."nonallid"..text)
local bann = LuaTele.getUser(fsvhhh)
hsabe = Redis:get(TheBekme.."nnonb"..fsvhhh)
nouu = Redis:get(TheBekme.."nnonbn"..fsvhhh)
...
if Redis:get(TheBekme.."hramep" .. UserNameyr) then  
local check_time = Redis:ttl(TheBekme.."hramep" .. UserNameyr)
rr = oger(check_time)
...
Redis:incrby(TheBekme.."nool:flotysb"..fsvhhh ,UserNameyy)
Redis:decrby(TheBekme.."nool:flotysb"..msg.sender.user_id ,UserNamey)
Redis:setex(TheBekme.."polici" .. msg.sender.user_id,600, true)
Redis:setex(TheBekme.."hramep" ..UserNamey ,600, true)
...
ballancee = Redis:get(TheBekme.."nool:flotysb"..bl) or 0
Redis:decrby(TheBekme.."nool:flotysb"..bl , ballancee)
LuaTele.sendText(msg.chat_id,msg.id, "*تم تصفيرة بنجاح !*","md",true)
end

if text == 'قرض' or text == 'قرض' then
if Redis:sismember(TheBekme.."noooybgy",msg.sender.user_id) then
if Redis:get(TheBekme.."nnoo1" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheBekme.."nnoo1" .. msg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• من شوي عطيتك انتظر "..rr.." دقيقة") 
end
if Redis:get(TheBekme.."xxxr" .. msg.sender.user_id) then
Redis:incrby(TheBekme.."nool:flotysb"..msg.sender.user_id , 1000000)
Redis:sadd(TheBekme.."ttpppi",msg.sender.user_id)
return LuaTele.sendText(msg.chat_id,msg.id,"• خذ قرض 1000000 دولار 💸","md",true)
end
local jjjo = "6000000"
Redis:incrby(TheBekme.."nool:flotysb"..msg.sender.user_id , jjjo)
Redis:sadd(TheBekme.."ttpppi",msg.sender.user_id)
LuaTele.sendText(msg.chat_id,msg.id,"• خذ ي مطفر "..jjjo.." دولار 💸","md",true)
Redis:setex(TheBekme.."nnoo1" .. msg.sender.user_id,600, true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:sismember(TheBekme.."noooybgy",msg.sender.user_id) then
if Redis:get(TheBekme.."nnoo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheBekme.."nnoo" .. msg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• من شوي عطيتك انتظر "..rr.." دقيقة") 
end
if Redis:get(TheBekme.."xxxr" .. msg.sender.user_id) then
Redis:incrby(TheBekme.."nool:flotysb"..msg.sender.user_id , 3000)
Redis:sadd(TheBekme.."ttpppi",msg.sender.user_id)
...
Redis:sadd(TheBekme.."ttpppi",msg.sender.user_id)
LuaTele.sendText(msg.chat_id,msg.id,"• خذ ي مطفر "..jjjo.." دولار 💸","md",true)
Redis:setex(TheBekme.."nnoo" .. msg.sender.user_id,600, true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:sismember(TheBekme.."noooybgy",UserId_Info.id) then
ballanceed = Redis:get(TheBekme.."nool:flotysb"..UserId_Info.id) or 0
LuaTele.sendText(msg.chat_id,msg.id, "• فلوسه "..ballanceed.." دولار 💸","md",true)
else
...
if Redis:get(TheBekme.."polic" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheBekme.."polic" .. msg.sender.user_id)
rr = oger(check_time)
...
if Redis:get(TheBekme.."hrame" .. Remsg.sender.user_id) then  
local check_time = Redis:ttl(TheBekme.."hrame" .. Remsg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• زارفينه قبلك \n• يمديك تزرفه بعد "..rr.." دقيقة") 
end 
if Redis:sismember(TheBekme.."noooybgy",Remsg.sender.user_id) then
ballanceed = Redis:get(TheBekme.."nool:flotysb"..Remsg.sender.user_id) or 0
...
local ballanceed = Redis:get(TheBekme.."nool:flotysb"..Remsg.sender.user_id) or 0
Redis:incrby(TheBekme.."nool:flotysb"..msg.sender.user_id , hrame)
Redis:decrby(TheBekme.."nool:flotysb"..Remsg.sender.user_id , hrame)
Redis:sadd(TheBekme.."ttpppi",msg.sender.user_id)
Redis:setex(TheBekme.."hrame" .. Remsg.sender.user_id,900, true)
Redis:incrby(TheBekme.."zrffdcf"..msg.sender.user_id,hrame)
Redis:sadd(TheBekme.."zrfffidtf",msg.sender.user_id)
Redis:setex(TheBekme.."polic" .. msg.sender.user_id,300, true)
...
Redis:incrby(TheBekme.."nool:flotysb"..msg.sender.user_id , F)
local ballancee = Redis:get(TheBekme.."nool:flotysb"..msg.sender.user_id) or 0
...
Redis:setex(TheBekme.."innoo" .. msg.sender.user_id,600, true)
end
if text == 'راتب' or text == 'راتبي' then
if Redis:sismember(TheBekme.."noooybgy",msg.sender.user_id) then
if Redis:get(TheBekme.."innoo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheBekme.."innoo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:set(TheBekme.."Bekme:Game:Monotonous"..msg.chat_id,name)
...
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(TheBekme.."mshaher"..msg.chat_id,name)
...
Redis:set(TheBekme.."Bekme:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(TheBekme.."Bekme:Status:Games"..msg.chat_id) then
Redis:del(TheBekme.."Bekme:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(TheBekme.."Bekme:Game:Meaningof"..msg.chat_id,name)
...
if Redis:get(TheBekme.."Bekme:Status:Games"..msg.chat_id) then
Redis:del(TheBekme.."Set:Country"..msg.chat_id)
...
Redis:set(TheBekme.."Game:Countrygof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(TheBekme.."Bekme:Status:Games"..msg.chat_id) then
Redis:del(TheBekme.."Bekme:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(TheBekme.."Bekme:Game:Reflection"..msg.chat_id,name)
...
Redis:set(TheBekme.."Bekme:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(TheBekme.."Bekme:Game:Difference"..msg.chat_id,name)
...
Redis:set(TheBekme.."Bekme:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(TheBekme.."Bekme:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(TheBekme.."Bekme:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(TheBekme.."Bekme:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(TheBekme.."Bekme:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(TheBekme.."Bekme:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(TheBekme.."Bekme:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
Redis:sadd(TheBekme..'Bekme:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(TheBekme.."Bekme:Start:Bot") then
local CmdStart = '*\n‹ : اهلا بك عزيزي في بوت '..(Redis:get(TheBekme.."Bekme:Name:Bot") or "Bekme")..
...
{
{text = '‹ لتنصيب بوت ›', url = 't.me/UU7UD'},
},
{
{text = '‹ 𝘵𝘦𝘢𝘮 𝘣𝘦𝘬𝘮𝘢 ›', url = 't.me/UWUWC'},
},
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TheBekme.."Bekme:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(TheBekme.."Bekme:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TheBekme.."Bekme:Start:Bot") 
...
LuaTele.sendText(msg_chat_id,msg_id,'*‹ : عدد احصائيات البوت الكامله \n⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : عدد المجموعات : '..(Redis:scard(TheBekme..'Bekme:ChekBotAdd') or 0)..'\n‹ : عدد المشتركين : '..(Redis:scard(TheBekme..'Bekme:Num:User:Pv') or 0)..'*',"md",true)  
end
if text == 'الرتبه' or text == 'رتبته'  and msg.reply_to_message_id ~= 0 then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = LuaTele.getUser(Message_Reply.sender.user_id)
...
if not msg.ControllerBot then
if Redis:get(TheBekme.."Bekme:TwaslBot") and not Redis:sismember(TheBekme.."Bekme:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(TheBekme.."Bekme:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(TheBekme.."Bekme:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(TheBekme..'Bekme:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'‹ : تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(TheBekme..'Bekme:BaN:In:Tuasl',Info_User)  
...
Redis:srem(TheBekme.."Bekme:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(TheBekme..'*'..'-100'..data.supergroup.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(TheBekme.."Bekme:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheBekme.."Bekme:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(TheBekme.."Bekme:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheBekme.."Bekme:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(TheBekme.."Bekme:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheBekme.."Bekme:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(TheBekme.."Bekme:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheBekme.."Bekme:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(TheBekme.."Bekme:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheBekme.."Bekme:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(TheBekme.."Bekme:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheBekme.."Bekme:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(TheBekme.."Bekme:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheBekme.."Bekme:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(TheBekme.."Bekme:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheBekme.."Bekme:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(TheBekme.."Bekme:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheBekme.."Bekme:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(TheBekme.."Bekme:Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(TheBekme) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(TheBekme..'Bekme:Status:joinet'..data.message.chat_id) == 'true' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if Message_Edit.sender.user_id == TheBekme then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(TheBekme..'Bekme:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(TheBekme.."Bekme:Lock:edit"..data.chat_id) then
...
local Get_Chat = LuaTele.getChat(ChatId)
local GetLink = Redis:get(TheBekme.."Bekme:Group:Link"..ChatId) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{
...
return LuaTele.editMessageText(ChatId,Msg_id,"*‹ : عمري اختار صيغ التنزيل ! *", "md", true, false, reply_markup)
end
end
...
io.popen("curl -s 'http://185.185.127.158/Bekme/yt2.php?url="..listYt[2].."&token="..Token.."&chat="..ChatId.."&type=ogg&msg=0'")
end
end
...
if tonumber(listYt[1]) == tonumber(IdUser) then
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
io.popen("curl -s 'http://185.185.127.158/Bekme/yt2.php?url="..listYt[2].."&token="..Token.."&chat="..ChatId.."&type=mp3&msg=0'")
end
end
...
if tonumber(listYt[1]) == tonumber(IdUser) then
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
io.popen("curl -s 'http://185.185.127.158/Bekme/yt2.php?url="..listYt[2].."&token="..Token.."&chat="..ChatId.."&type=mp4&msg=0'")
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Abs = math.random(2,54); 
local Text ='* ‹ 𝘵𝘦𝘢𝘮 𝘣𝘦𝘬𝘮𝘢 › \n⋆┄┄─┄─┄─┄┄─┄─┄┄⋆*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '‹ 𝘵𝘦𝘢𝘮 𝘣𝘦𝘬𝘮𝘢 ›',url="https://t.me/UWUWC"},{text = ' Updates source ⁦ᯓ',url="https://t.me/UWUWC"}
},
{
{text = ' مبرمج السورس',url="https://t.me/UU7UD"}
},
}
local msg_id = Msg_id/2097152/0.5
...
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. ChatId .. '&voice=https://t.me/shaarBekme/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
end
end
...
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..UserId[2]..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..UserId[2]..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..UserId[2]..":"..'ا','ايدي')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..UserId[2]..":"..'م','رفع مميز')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..UserId[2]..":"..'اد', 'رفع ادمن')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..UserId[2]..":"..'مد','رفع مدير')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..UserId[2]..":"..'من', 'رفع منشئ')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..UserId[2]..":"..'اس', 'رفع منشئ اساسي')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..UserId[2]..":"..'مط','رفع مطور')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..UserId[2]..":"..'تك','تنزيل الكل')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..UserId[2]..":"..'ر','الرابط')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..UserId[2]..":"..'رر','ردود المدير')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..UserId[2]..":"..'،،','مسح المكتومين')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..UserId[2]..":"..'رد','اضف رد')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..UserId[2]..":"..'سح','مسح سحكاتي')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..UserId[2]..":"..'غ','غنيلي')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..UserId[2]..":"..'رس','رسائلي')
Redis:set(TheBekme.."Bekme:Get:Reides:Commands:Group"..UserId[2]..":"..'ثانوي','رفع مطور ثانوي')
...
if tonumber(listYt[1]) == tonumber(IdUser) then
Redis:srem(TheBekme.."Bekme:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(TheBekme.."Bekme:BanGroup:Group"..ChatId,listYt[2]) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:del(TheBekme.."Bekme:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(TheBekme.."Bekme1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(TheBekme.."Bekme:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(TheBekme.."Bekme:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheBekme.."Bekme:Redis:Id:Group"..ChatId..""..IdUser,true) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheBekme.."Bekme1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheBekme.."Bekme:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"‹ : ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheBekme.."Bekme:Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"‹ : ارسل لي الرد الان", 'md', true)
end
end
...
Redis:incrby(TheBekme.."Bekme:Num:Add:Games"..ChatId..IdUser, 1)  
...
{
{text = 'اوامر المطورين', data = IdUser..'/help5'}, {text = 'اوامر التحشيش', data = IdUser..'/help7'}, 
},
{
...
data = {
{
{text = 'اوامر الحمايه', data = IdUser..'/help1'}, {text = '- ?? -', data = IdUser..'/help2'}, 
},
{
{text = 'اوامر المدراء', data = IdUser..'/help3'}, {text = 'اوامر المنشئين', data = IdUser..'/help4'}, 
},
...
local TextHelp = [[*
‹ : أهلا بك في قائمة العاب سورس بيكما اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
‹ : مرحبا بك في الالعاب المتطورة الخاص بسورس بيكما
...
data = {
{
{text = '‹ الالعاب المتطورة ›', data = IdUser..'/degm'}, 
},
{
{text = '‹ 𝘵𝘦𝘢𝘮 𝘣𝘦𝘬𝘮𝘢 › ', url = 't.me/UWUWC'}, 
},
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheBekme.."Bekme:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheBekme.."Bekme:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheBekme.."Bekme:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheBekme.."Bekme:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheBekme.."Bekme:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheBekme.."Bekme:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheBekme.."Bekme:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(TheBekme.."Bekme:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheBekme..'Bekme:'..lock..UserId[2],"del")    
end
...
local bank_users = Redis:smembers(TheBekme.."almtzog"..ChatId)
top_mony = "توب اغنى 10 زوجات بالقروب :\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(TheBekme.."mznom"..ChatId..v)
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
for k,v in pairs(mony_list) do
if num <= 10 then
local zwga_id = Redis:get(TheBekme..ChatId..v[2].."rgalll2:")
local user_name = LuaTele.getUser(v[2]).first_name
local user_nambe = LuaTele.getUser(zwga_id).first_name
...
ballancee = Redis:get(TheBekme.."zrffdcf"..IdUser) or 0
local bank_users = Redis:smembers(TheBekme.."zrfffidtf")
top_mony = "توب اكثر 25 شخص حرامية فلوس:\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
...
ballancee = Redis:get(TheBekme.."nool:flotysb"..IdUser) or 0
local bank_users = Redis:smembers(TheBekme.."ttpppi")
top_mony = "توب اغنى 25 شخص :\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(TheBekme.."Bekme:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."wtka:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."klb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."mar:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."smb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."kholat:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."8by:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."3ra:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"‹ : تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheBekme.."Bekme:SilentGroup:Group"..ChatId) 
